...
/*   47 */     public VisualID() { this(0L); } public VisualID(long param1Long) {
/*   48 */       super(param1Long, true);
/*      */     } protected boolean isNone(Object param1Object) {
/*   50 */       return (param1Object == null || (param1Object instanceof Number && ((Number)param1Object)
/*      */         
/*   52 */         .longValue() == 0L));
/*      */     }
/*      */     
/*      */     public Object fromNative(Object param1Object, FromNativeContext param1FromNativeContext) {
/*   56 */       if (isNone(param1Object))
/*   57 */         return None; 
/*   58 */       return new VisualID(((Number)param1Object).longValue());
/*      */     }
/*      */   }
/*      */   
...
/*   65 */     public XID() { this(0L); } public XID(long param1Long) {
/*   66 */       super(param1Long, true);
/*      */     } protected boolean isNone(Object param1Object) {
/*   68 */       return (param1Object == null || (param1Object instanceof Number && ((Number)param1Object)
/*      */         
/*   70 */         .longValue() == 0L));
/*      */     }
/*      */     
/*      */     public Object fromNative(Object param1Object, FromNativeContext param1FromNativeContext) {
/*   74 */       if (isNone(param1Object))
/*   75 */         return None; 
/*   76 */       return new XID(((Number)param1Object).longValue());
/*      */     }
/*      */     
...
/*      */     
/*      */     public Object fromNative(Object param1Object, FromNativeContext param1FromNativeContext) {
/*   91 */       long l = ((Number)param1Object).longValue();
/*   92 */       if (l <= 2147483647L) {
/*   93 */         switch ((int)l) { case 0:
/*   94 */             return None;
...
/*  172 */       NativeLong nativeLong = getPointer().getNativeLong(0L);
/*  173 */       return (X11.Atom)(new X11.Atom()).fromNative(nativeLong, null);
/*      */     } }
/*      */   
...
/*  180 */       super(param1Long);
/*      */     }
/*      */     public Object fromNative(Object param1Object, FromNativeContext param1FromNativeContext) {
/*  183 */       if (isNone(param1Object))
/*  184 */         return None; 
/*  185 */       return new Colormap(((Number)param1Object).longValue());
/*      */     }
/*      */   }
/*      */   
...
/*  192 */       super(param1Long);
/*      */     }
/*      */     public Object fromNative(Object param1Object, FromNativeContext param1FromNativeContext) {
/*  195 */       if (isNone(param1Object))
/*  196 */         return None; 
/*  197 */       return new Font(((Number)param1Object).longValue());
/*      */     } }
/*      */   
...
/*  204 */       super(param1Long);
/*      */     }
/*      */     public Object fromNative(Object param1Object, FromNativeContext param1FromNativeContext) {
/*  207 */       if (isNone(param1Object))
/*  208 */         return None; 
/*  209 */       return new Cursor(((Number)param1Object).longValue());
/*      */     }
/*      */   }
/*      */   
...
/*  216 */       super(param1Long);
/*      */     }
/*      */     public Object fromNative(Object param1Object, FromNativeContext param1FromNativeContext) {
/*  219 */       if (isNone(param1Object))
/*  220 */         return None; 
/*  221 */       return new KeySym(((Number)param1Object).longValue());
/*      */     } }
/*      */   
...
/*  228 */       super(param1Long);
/*      */     }
/*      */     public Object fromNative(Object param1Object, FromNativeContext param1FromNativeContext) {
/*  231 */       if (isNone(param1Object))
/*  232 */         return None; 
/*  233 */       return new Drawable(((Number)param1Object).longValue());
/*      */     }
/*      */   }
/*      */   
...
/*  240 */       super(param1Long);
/*      */     }
/*      */     public Object fromNative(Object param1Object, FromNativeContext param1FromNativeContext) {
/*  243 */       if (isNone(param1Object))
/*  244 */         return None; 
/*  245 */       return new Window(((Number)param1Object).longValue());
/*      */     } }
/*      */   
...
/*  251 */       NativeLong nativeLong = getPointer().getNativeLong(0L);
/*  252 */       return (nativeLong.longValue() == 0L) ? X11.Window.None : new X11.Window(nativeLong.longValue());
/*      */     } }
/*      */   
...
/*  259 */       super(param1Long);
/*      */     }
/*      */     public Object fromNative(Object param1Object, FromNativeContext param1FromNativeContext) {
/*  262 */       if (isNone(param1Object))
/*  263 */         return None; 
/*  264 */       return new Pixmap(((Number)param1Object).longValue());
/*      */     }
/*      */   }
/*      */   
...
/*      */     extends Library
/*      */   {
/*  301 */     public static final Xext INSTANCE = (Xext)Native.load("Xext", Xext.class);
/*      */     
...
/*      */     extends Library
/*      */   {
/*  319 */     public static final Xrender INSTANCE = (Xrender)Native.load("Xrender", Xrender.class); public static final int PictTypeIndexed = 0; public static final int PictTypeDirect = 1;
...
/*  332 */       public PictFormat(long param2Long) { super(param2Long); } public PictFormat() {
/*  333 */         this(0L);
/*      */       }
/*      */       public Object fromNative(Object param2Object, FromNativeContext param2FromNativeContext) {
/*  336 */         if (isNone(param2Object))
/*  337 */           return None; 
/*  338 */         return new PictFormat(((Number)param2Object).longValue());
/*      */       } }
/*      */ 
/*      */ 
/*      */     
...
/*      */     extends Library
/*      */   {
/*  358 */     public static final Xevie INSTANCE = (Xevie)Native.load("Xevie", Xevie.class); public static final int XEVIE_UNMODIFIED = 0; public static final int XEVIE_MODIFIED = 1;
...
/*      */     
/*  375 */     public static final XTest INSTANCE = (XTest)Native.load("Xtst", XTest.class);
/*      */     
...
/*      */   }
/*  407 */   public static final X11 INSTANCE = (X11)Native.load("X11", X11.class);
/*      */   
...
/*      */     
/*      */     public XPoint() {
/*  649 */       this((short)0, (short)0);
/*      */     } public XPoint(short param1Short1, short param1Short2) {
/*  651 */       this.x = param1Short1;
/*  652 */       this.y = param1Short2;
/*      */     } }
...
/*      */     
/*      */     public XRectangle() {
/*  661 */       this((short)0, (short)0, (short)0, (short)0);
/*      */     } public XRectangle(short param1Short1, short param1Short2, short param1Short3, short param1Short4) {
/*  663 */       this.x = param1Short1; this.y = param1Short2;
/*  664 */       this.width = param1Short3; this.height = param1Short4;
/*      */     } }
/*      */ 
/*      */   
/*  668 */   public static final Atom XA_PRIMARY = new Atom(1L);
/*  669 */   public static final Atom XA_SECONDARY = new Atom(2L);
/*  670 */   public static final Atom XA_ARC = new Atom(3L);
/*  671 */   public static final Atom XA_ATOM = new Atom(4L);
/*  672 */   public static final Atom XA_BITMAP = new Atom(5L);
/*  673 */   public static final Atom XA_CARDINAL = new Atom(6L);
/*  674 */   public static final Atom XA_COLORMAP = new Atom(7L);
/*  675 */   public static final Atom XA_CURSOR = new Atom(8L);
/*  676 */   public static final Atom XA_CUT_BUFFER0 = new Atom(9L);
/*  677 */   public static final Atom XA_CUT_BUFFER1 = new Atom(10L);
/*  678 */   public static final Atom XA_CUT_BUFFER2 = new Atom(11L);
/*  679 */   public static final Atom XA_CUT_BUFFER3 = new Atom(12L);
/*  680 */   public static final Atom XA_CUT_BUFFER4 = new Atom(13L);
/*  681 */   public static final Atom XA_CUT_BUFFER5 = new Atom(14L);
/*  682 */   public static final Atom XA_CUT_BUFFER6 = new Atom(15L);
/*  683 */   public static final Atom XA_CUT_BUFFER7 = new Atom(16L);
/*  684 */   public static final Atom XA_DRAWABLE = new Atom(17L);
/*  685 */   public static final Atom XA_FONT = new Atom(18L);
/*  686 */   public static final Atom XA_INTEGER = new Atom(19L);
/*  687 */   public static final Atom XA_PIXMAP = new Atom(20L);
/*  688 */   public static final Atom XA_POINT = new Atom(21L);
/*  689 */   public static final Atom XA_RECTANGLE = new Atom(22L);
/*  690 */   public static final Atom XA_RESOURCE_MANAGER = new Atom(23L);
/*  691 */   public static final Atom XA_RGB_COLOR_MAP = new Atom(24L);
/*  692 */   public static final Atom XA_RGB_BEST_MAP = new Atom(25L);
/*  693 */   public static final Atom XA_RGB_BLUE_MAP = new Atom(26L);
/*  694 */   public static final Atom XA_RGB_DEFAULT_MAP = new Atom(27L);
/*  695 */   public static final Atom XA_RGB_GRAY_MAP = new Atom(28L);
/*  696 */   public static final Atom XA_RGB_GREEN_MAP = new Atom(29L);
/*  697 */   public static final Atom XA_RGB_RED_MAP = new Atom(30L);
/*  698 */   public static final Atom XA_STRING = new Atom(31L);
/*  699 */   public static final Atom XA_VISUALID = new Atom(32L);
/*  700 */   public static final Atom XA_WINDOW = new Atom(33L);
/*  701 */   public static final Atom XA_WM_COMMAND = new Atom(34L);
/*  702 */   public static final Atom XA_WM_HINTS = new Atom(35L);
/*  703 */   public static final Atom XA_WM_CLIENT_MACHINE = new Atom(36L);
/*  704 */   public static final Atom XA_WM_ICON_NAME = new Atom(37L);
/*  705 */   public static final Atom XA_WM_ICON_SIZE = new Atom(38L);
/*  706 */   public static final Atom XA_WM_NAME = new Atom(39L);
/*  707 */   public static final Atom XA_WM_NORMAL_HINTS = new Atom(40L);
/*  708 */   public static final Atom XA_WM_SIZE_HINTS = new Atom(41L);
/*  709 */   public static final Atom XA_WM_ZOOM_HINTS = new Atom(42L);
/*  710 */   public static final Atom XA_MIN_SPACE = new Atom(43L);
/*  711 */   public static final Atom XA_NORM_SPACE = new Atom(44L);
/*  712 */   public static final Atom XA_MAX_SPACE = new Atom(45L);
/*  713 */   public static final Atom XA_END_SPACE = new Atom(46L);
/*  714 */   public static final Atom XA_SUPERSCRIPT_X = new Atom(47L);
/*  715 */   public static final Atom XA_SUPERSCRIPT_Y = new Atom(48L);
/*  716 */   public static final Atom XA_SUBSCRIPT_X = new Atom(49L);
/*  717 */   public static final Atom XA_SUBSCRIPT_Y = new Atom(50L);
/*  718 */   public static final Atom XA_UNDERLINE_POSITION = new Atom(51L);
/*  719 */   public static final Atom XA_UNDERLINE_THICKNESS = new Atom(52L);
/*  720 */   public static final Atom XA_STRIKEOUT_ASCENT = new Atom(53L);
/*  721 */   public static final Atom XA_STRIKEOUT_DESCENT = new Atom(54L);
/*  722 */   public static final Atom XA_ITALIC_ANGLE = new Atom(55L);
/*  723 */   public static final Atom XA_X_HEIGHT = new Atom(56L);
/*  724 */   public static final Atom XA_QUAD_WIDTH = new Atom(57L);
/*  725 */   public static final Atom XA_WEIGHT = new Atom(58L);
/*  726 */   public static final Atom XA_POINT_SIZE = new Atom(59L);
/*  727 */   public static final Atom XA_RESOLUTION = new Atom(60L);
/*  728 */   public static final Atom XA_COPYRIGHT = new Atom(61L);
/*  729 */   public static final Atom XA_NOTICE = new Atom(62L);
/*  730 */   public static final Atom XA_FONT_NAME = new Atom(63L);
/*  731 */   public static final Atom XA_FAMILY_NAME = new Atom(64L);
/*  732 */   public static final Atom XA_FULL_NAME = new Atom(65L);
/*  733 */   public static final Atom XA_CAP_HEIGHT = new Atom(66L);
/*  734 */   public static final Atom XA_WM_CLASS = new Atom(67L);
/*  735 */   public static final Atom XA_WM_TRANSIENT_FOR = new Atom(68L);
/*  736 */   public static final Atom XA_LAST_PREDEFINED = XA_WM_TRANSIENT_FOR;
/*      */   
...
/*      */     public Data data;
/*      */     
/* 1547 */     public static class Data extends Union { public byte[] b = new byte[20];
...
/*      */     
/*      */     public String toString() {
/* 2266 */       return "XKeyboardControlByReference{key_click_percent=" + this.key_click_percent + ", bell_percent=" + this.bell_percent + ", bell_pitch=" + this.bell_pitch + ", bell_duration=" + this.bell_duration + ", led=" + this.led + ", led_mode=" + this.led_mode + ", key=" + this.key + ", auto_repeat_mode=" + this.auto_repeat_mode + '}';
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     
/*      */     public String toString() {
/* 2298 */       return "XKeyboardStateByReference{key_click_percent=" + this.key_click_percent + ", bell_percent=" + this.bell_percent + ", bell_pitch=" + this.bell_pitch + ", bell_duration=" + this.bell_duration + ", led_mask=" + this.led_mask + ", global_auto_repeat=" + this.global_auto_repeat + ", auto_repeats=" + this.auto_repeats + '}';
/*      */     }
/*      */   }
/*      */ }


/* Location:              C:\Arremate\Arremate.jar!\com\sun\jna\platfor\\unix\X11.class
