...
public interface CTShapetype extends XmlObject {
  ...
  void setComplex(CTComplex paramCTComplex);
  ...
  void setMaster(String paramString);
  
  void xsetMaster(XmlString paramXmlString);
  ...
  public static final class Factory {
    ...
    public static CTShapetype newInstance(XmlOptions param1XmlOptions) {
      return (CTShapetype)POIXMLTypeLoader.newInstance(CTShapetype.type, param1XmlOptions);
    }
    
    public static CTShapetype parse(String param1String) throws XmlException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1String, CTShapetype.type, null);
    }
    
    public static CTShapetype parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1String, CTShapetype.type, param1XmlOptions);
    }
    
    public static CTShapetype parse(File param1File) throws XmlException, IOException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1File, CTShapetype.type, null);
    }
    
    public static CTShapetype parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1File, CTShapetype.type, param1XmlOptions);
    }
    
    public static CTShapetype parse(URL param1URL) throws XmlException, IOException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1URL, CTShapetype.type, null);
    }
    
    public static CTShapetype parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1URL, CTShapetype.type, param1XmlOptions);
    }
    
    public static CTShapetype parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1InputStream, CTShapetype.type, null);
    }
    
    public static CTShapetype parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1InputStream, CTShapetype.type, param1XmlOptions);
    }
    
    public static CTShapetype parse(Reader param1Reader) throws XmlException, IOException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1Reader, CTShapetype.type, null);
    }
    
    public static CTShapetype parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1Reader, CTShapetype.type, param1XmlOptions);
    }
    
    public static CTShapetype parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1XMLStreamReader, CTShapetype.type, null);
    }
    
    public static CTShapetype parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1XMLStreamReader, CTShapetype.type, param1XmlOptions);
    }
    
    public static CTShapetype parse(Node param1Node) throws XmlException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1Node, CTShapetype.type, null);
    }
    
    public static CTShapetype parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1Node, CTShapetype.type, param1XmlOptions);
    }
    
    public static CTShapetype parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1XMLInputStream, CTShapetype.type, null);
    }
    
    public static CTShapetype parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTShapetype)POIXMLTypeLoader.parse(param1XMLInputStream, CTShapetype.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTShapetype.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTShapetype.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\com\microsoft\schemas\vml\CTShapetype.class
