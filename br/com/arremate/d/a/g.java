...
/*    */   extends f
/*    */ {
/*    */   public g(e parame, i parami, br.com.arremate.d.g paramg) {
...
/* 30 */       super.P();
/*    */       
/* 32 */       br.com.arremate.l.g g1 = a().a();
/* 33 */       if (g1.z() <= TimeUnit.MINUTES.toMillis(2L) && a().bt()) {
/* 34 */         a().N(br.com.arremate.f.g.I.getValue());
/*    */       }
/*    */       
/* 37 */       if (g1.as()) {
...
/* Location:              C:\Arremate\Arremate.jar!\br\com\arremate\d\a\g.class
