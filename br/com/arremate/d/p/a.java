...
/*     */       
/*  83 */       c c = a().a();
/*  84 */       String str1 = a().c(Integer.valueOf(c.v()), Integer.valueOf(c.a().w()));
/*     */       
/*  86 */       if (!"".equals(str1)) {
/*  87 */         i i = new i(str1);
...
/*     */       }
/*     */       
/* 100 */       String str3 = str2.substring(str2.indexOf("DestacarChat"));
/* 101 */       str3 = str3.substring(str3.indexOf("q=") + 2, str3.indexOf(";"));
/* 102 */       str3 = str3.substring(0, str3.indexOf("'"));
/*     */       
/* 104 */       this.aj = str3;
/*     */       return;
/* 106 */     } catch (Exception exception) {
/* 107 */       a.error("#002 - Failed to load hash chat", exception);
/* 108 */       a().h("#002 - Failed to load hash chat");
/*     */ 
/*     */       
/* 111 */       this.aj = "";
/*     */       return;
/*     */     } 
/*     */   }
/*     */   public br.com.arremate.j.g.a a() {
/* 116 */     return (br.com.arremate.j.g.a)super.a();
/*     */   }
/*     */ 
/*     */   
/*     */   public e a() {
/* 121 */     return (e)super.a();
/*     */   }
/*     */ }


/* Location:              C:\Arremate\Arremate.jar!\br\com\arremate\d\p\a.class
