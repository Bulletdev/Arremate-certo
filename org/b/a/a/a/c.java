...
public interface c extends XmlObject {
  public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(c.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.s8C3F193EE11A2F798ACF65489B9E6078").resolveHandle("crlrefstype2a59type");
  ...
  void a(b[] paramArrayOfb);
  
  void a(int paramInt, b paramb);
  
  b b(int paramInt);
  
  b b();
  
  void aU(int paramInt);
...
/* Location:              C:\Arremate\Arremate.jar!\org\b\a\a\a\c.class
