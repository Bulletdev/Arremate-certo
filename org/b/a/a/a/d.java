...
public interface d extends XmlObject {
  public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(d.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.s8C3F193EE11A2F798ACF65489B9E6078").resolveHandle("crlvaluestype0ebbtype");
  ...
  void a(k[] paramArrayOfk);
  
  void a(int paramInt, k paramk);
  
  k b(int paramInt);
  
  k a();
  
  void aV(int paramInt);
...
/* Location:              C:\Arremate\Arremate.jar!\org\b\a\a\a\d.class
