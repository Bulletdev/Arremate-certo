...
public interface a extends XmlObject {
  public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(a.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.s8C3F193EE11A2F798ACF65489B9E6078").resolveHandle("crlidentifiertypeb702type");
  
  String ed();
  
  XmlString a();
  
  void bi(String paramString);
  
  void a(XmlString paramXmlString);
  
  Calendar j();
  
  XmlDateTime a();
  
  void c(Calendar paramCalendar);
  
  void a(XmlDateTime paramXmlDateTime);
  ...
  void a(XmlInteger paramXmlInteger);
