...
/* 74 */     Header[] arrayOfHeader = paramHttpResponse.getHeaders("WWW-Authenticate");
...
/* 84 */     List<String> list = (List)paramHttpResponse.getParams().getParameter("http.auth.target-scheme-pref");
/*    */     
/* 86 */     if (list != null) {
/* 87 */       return list;
/*    */     }
...
/* Location:              C:\Arremate\Arremate.jar!\org\apache\http\impl\client\DefaultTargetAuthenticationHandler.class
