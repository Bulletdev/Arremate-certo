...
/* 183 */     return crypt(paramArrayOfbyte, (String)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 204 */       ThreadLocalRandom threadLocalRandom = ThreadLocalRandom.current();
/* 205 */       int m = SALT_CHARS.length;
/*     */       
/* 207 */       paramString = "" + SALT_CHARS[threadLocalRandom.nextInt(m)] + SALT_CHARS[threadLocalRandom.nextInt(m)];
/* 208 */     } else if (!paramString.matches("^[./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz]{2,}$")) {
/* 209 */       throw new IllegalArgumentException("Invalid salt value: " + paramString);
/*     */     } 
/*     */     
/* 212 */     StringBuilder stringBuilder = new StringBuilder("             ");
/* 213 */     char c1 = paramString.charAt(0);
/* 214 */     char c2 = paramString.charAt(1);
/* 215 */     stringBuilder.setCharAt(0, c1);
/* 216 */     stringBuilder.setCharAt(1, c2);
/* 217 */     int i = CON_SALT[c1];
/* 218 */     int j = CON_SALT[c2] << 4;
/* 219 */     byte[] arrayOfByte1 = new byte[8]; byte b1;
/* 220 */     for (b1 = 0; b1 < arrayOfByte1.length; b1++) {
/* 221 */       arrayOfByte1[b1] = 0;
/*     */     }
/*     */     
/* 224 */     for (b1 = 0; b1 < arrayOfByte1.length && b1 < paramArrayOfbyte.length; b1++) {
/* 225 */       byte b = paramArrayOfbyte[b1];
/* 226 */       arrayOfByte1[b1] = (byte)(b << 1);
/*     */     } 
/*     */     
/* 229 */     int[] arrayOfInt1 = desSetKey(arrayOfByte1);
/* 230 */     int[] arrayOfInt2 = body(arrayOfInt1, i, j);
/* 231 */     byte[] arrayOfByte2 = new byte[9];
/* 232 */     intToFourBytes(arrayOfInt2[0], arrayOfByte2, 0);
/* 233 */     intToFourBytes(arrayOfInt2[1], arrayOfByte2, 4);
/* 234 */     arrayOfByte2[8] = 0;
/* 235 */     byte b2 = 2;
/* 236 */     byte b3 = 0;
/* 237 */     int k = 128;
/* 238 */     for (; b2 < 13; b2++) {
...
/* 249 */           k = 128;
/*     */         } 
/* 251 */         stringBuilder.setCharAt(b2, (char)COV2CHAR[m]);
/*     */       } 
/*     */     } 
...
/* 269 */     return crypt(paramString.getBytes(StandardCharsets.UTF_8));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 286 */     return crypt(paramString1.getBytes(StandardCharsets.UTF_8), paramString2);
/*     */   }
/*     */   
...
/* 291 */     int j = 0;
/* 292 */     int k = 0;
/* 293 */     for (byte b = 0; b < 25; b++) {
/* 294 */       for (byte b1 = 0; b1 < 32; b1 += 4) {
/* 295 */         i = dEncrypt(i, j, b1, paramInt1, paramInt2, paramArrayOfint);
/* 296 */         j = dEncrypt(j, i, b1 + 2, paramInt1, paramInt2, paramArrayOfint);
/*     */       } 
/* 298 */       k = i;
/* 299 */       i = j;
/* 300 */       j = k;
...
/* 304 */     j = i >>> 1 | i << 31;
/* 305 */     i = k >>> 1 | k << 31;
/* 306 */     int[] arrayOfInt1 = new int[2];
/* 307 */     permOp(j, i, 1, 1431655765, arrayOfInt1);
/* 308 */     j = arrayOfInt1[0];
/* 309 */     i = arrayOfInt1[1];
/* 310 */     permOp(i, j, 8, 16711935, arrayOfInt1);
/* 311 */     i = arrayOfInt1[0];
/* 312 */     j = arrayOfInt1[1];
/* 313 */     permOp(j, i, 2, 858993459, arrayOfInt1);
/* 314 */     j = arrayOfInt1[0];
/* 315 */     i = arrayOfInt1[1];
/* 316 */     permOp(i, j, 16, 65535, arrayOfInt1);
/* 317 */     i = arrayOfInt1[0];
/* 318 */     j = arrayOfInt1[1];
/* 319 */     permOp(j, i, 4, 252645135, arrayOfInt1);
/* 320 */     j = arrayOfInt1[0];
/* 321 */     i = arrayOfInt1[1];
/* 322 */     int[] arrayOfInt2 = new int[2];
/* 323 */     arrayOfInt2[0] = i;
/* 324 */     arrayOfInt2[1] = j;
/* 325 */     return arrayOfInt2;
/*     */   }
/*     */   
/*     */   private static int byteToUnsigned(byte paramByte) {
/* 329 */     byte b = paramByte;
/* 330 */     return (b < 0) ? (b + 256) : b;
/*     */   }
/*     */   
/*     */   private static int dEncrypt(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int[] paramArrayOfint) {
/* 334 */     int i = paramInt2 ^ paramInt2 >>> 16;
/* 335 */     int j = i & paramInt4;
/* 336 */     i &= paramInt5;
/* 337 */     j = j ^ j << 16 ^ paramInt2 ^ paramArrayOfint[paramInt3];
/* 338 */     int k = i ^ i << 16 ^ paramInt2 ^ paramArrayOfint[paramInt3 + 1];
/* 339 */     k = k >>> 4 | k << 28;
/* 340 */     paramInt1 ^= SPTRANS[1][k & 0x3F] | SPTRANS[3][k >>> 8 & 0x3F] | SPTRANS[5][k >>> 16 & 0x3F] | SPTRANS[7][k >>> 24 & 0x3F] | SPTRANS[0][j & 0x3F] | SPTRANS[2][j >>> 8 & 0x3F] | SPTRANS[4][j >>> 16 & 0x3F] | SPTRANS[6][j >>> 24 & 0x3F];
/*     */ 
/*     */     
...
/* 347 */     int[] arrayOfInt1 = new int[32];
/* 348 */     int i = fourBytesToInt(paramArrayOfbyte, 0);
/* 349 */     int j = fourBytesToInt(paramArrayOfbyte, 4);
/* 350 */     int[] arrayOfInt2 = new int[2];
/* 351 */     permOp(j, i, 4, 252645135, arrayOfInt2);
/* 352 */     j = arrayOfInt2[0];
/* 353 */     i = arrayOfInt2[1];
/* 354 */     i = hPermOp(i, -2, -859045888);
/* 355 */     j = hPermOp(j, -2, -859045888);
/* 356 */     permOp(j, i, 1, 1431655765, arrayOfInt2);
/* 357 */     j = arrayOfInt2[0];
/* 358 */     i = arrayOfInt2[1];
/* 359 */     permOp(i, j, 8, 16711935, arrayOfInt2);
/* 360 */     i = arrayOfInt2[0];
/* 361 */     j = arrayOfInt2[1];
/* 362 */     permOp(j, i, 1, 1431655765, arrayOfInt2);
/* 363 */     j = arrayOfInt2[0];
/* 364 */     i = arrayOfInt2[1];
/* 365 */     j = (j & 0xFF) << 16 | j & 0xFF00 | (j & 0xFF0000) >>> 16 | (i & 0xF0000000) >>> 4;
/* 366 */     i &= 0xFFFFFFF;
/* 367 */     byte b1 = 0;
/* 368 */     for (byte b2 = 0; b2 < 16; b2++) {
/* 369 */       if (SHIFT2[b2]) {
/* 370 */         i = i >>> 2 | i << 26;
/* 371 */         j = j >>> 2 | j << 26;
/*     */       } else {
...
/* 376 */       i &= 0xFFFFFFF;
/* 377 */       j &= 0xFFFFFFF;
/* 378 */       int k = SKB[0][i & 0x3F] | SKB[1][i >>> 6 & 0x3 | i >>> 7 & 0x3C] | SKB[2][i >>> 13 & 0xF | i >>> 14 & 0x30] | SKB[3][i >>> 20 & 0x1 | i >>> 21 & 0x6 | i >>> 22 & 0x38];
/*     */ 
/*     */       
/* 381 */       int m = SKB[4][j & 0x3F] | SKB[5][j >>> 7 & 0x3 | j >>> 8 & 0x3C] | SKB[6][j >>> 15 & 0x3F] | SKB[7][j >>> 21 & 0xF | j >>> 22 & 0x30];
/*     */       
/* 383 */       arrayOfInt1[b1++] = m << 16 | k & 0xFFFF;
/* 384 */       k = k >>> 16 | m & 0xFFFF0000;
/* 385 */       k = k << 4 | k >>> 28;
/* 386 */       arrayOfInt1[b1++] = k;
/*     */     } 
/*     */     
/* 389 */     return arrayOfInt1;
/*     */   }
/*     */   
/*     */   private static int fourBytesToInt(byte[] paramArrayOfbyte, int paramInt) {
/* 393 */     int i = byteToUnsigned(paramArrayOfbyte[paramInt++]);
/* 394 */     i |= byteToUnsigned(paramArrayOfbyte[paramInt++]) << 8;
/* 395 */     i |= byteToUnsigned(paramArrayOfbyte[paramInt++]) << 16;
/* 396 */     i |= byteToUnsigned(paramArrayOfbyte[paramInt++]) << 24;
/* 397 */     return i;
/*     */   }
/*     */   
/*     */   private static int hPermOp(int paramInt1, int paramInt2, int paramInt3) {
/* 401 */     int i = (paramInt1 << 16 - paramInt2 ^ paramInt1) & paramInt3;
/* 402 */     paramInt1 = paramInt1 ^ i ^ i >>> 16 - paramInt2;
/* 403 */     return paramInt1;
/*     */   }
/*     */   
/*     */   private static void intToFourBytes(int paramInt1, byte[] paramArrayOfbyte, int paramInt2) {
/* 407 */     paramArrayOfbyte[paramInt2++] = (byte)(paramInt1 & 0xFF);
/* 408 */     paramArrayOfbyte[paramInt2++] = (byte)(paramInt1 >>> 8 & 0xFF);
/* 409 */     paramArrayOfbyte[paramInt2++] = (byte)(paramInt1 >>> 16 & 0xFF);
/* 410 */     paramArrayOfbyte[paramInt2++] = (byte)(paramInt1 >>> 24 & 0xFF);
/*     */   }
/*     */   
/*     */   private static void permOp(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfint) {
/* 414 */     int i = (paramInt1 >>> paramInt3 ^ paramInt2) & paramInt4;
/* 415 */     paramInt1 ^= i << paramInt3;
/* 416 */     paramInt2 ^= i;
/* 417 */     paramArrayOfint[0] = paramInt1;
/* 418 */     paramArrayOfint[1] = paramInt2;
/*     */   }
/*     */ }


/* Location:              C:\Arremate\Arremate.jar!\org\apache\commons\codec\digest\UnixCrypt.class
