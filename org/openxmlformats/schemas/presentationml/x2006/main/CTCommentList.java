...
public interface CTCommentList extends XmlObject {
  ...
  CTComment getCmArray(int paramInt);
  
  int sizeOfCmArray();
  
  void setCmArray(CTComment[] paramArrayOfCTComment);
  
  void setCmArray(int paramInt, CTComment paramCTComment);
  
  CTComment insertNewCm(int paramInt);
  
  CTComment addNewCm();
  
  void removeCm(int paramInt);
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\presentationml\x2006\main\CTCommentList.class
