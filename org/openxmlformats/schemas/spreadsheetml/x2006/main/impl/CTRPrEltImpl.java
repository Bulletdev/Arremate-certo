...
public class CTRPrEltImpl extends XmlComplexContentImpl implements CTRPrElt {
  private static final b RFONT$0 = new b("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "rFont");
  ...
  public CTRPrEltImpl(SchemaType paramSchemaType) {
  ...
  public List<CTFontName> getRFontList() {
    synchronized (monitor()) {
      check_orphaned();
      return (List<CTFontName>)new RFontList(this);
    } 
  }
  ...
  public CTFontName getRFontArray(int paramInt) {
    synchronized (monitor()) {
      check_orphaned();
      CTFontName cTFontName = null;
      cTFontName = (CTFontName)get_store().find_element_user(RFONT$0, paramInt);
      if (cTFontName == null)
  ...
  public void setRFontArray(CTFontName[] paramArrayOfCTFontName) {
    synchronized (monitor()) {
      check_orphaned();
      arraySetterHelper((XmlObject[])paramArrayOfCTFontName, RFONT$0);
    } 
  }
  
  public void setRFontArray(int paramInt, CTFontName paramCTFontName) {
    synchronized (monitor()) {
      check_orphaned();
      CTFontName cTFontName = null;
      cTFontName = (CTFontName)get_store().find_element_user(RFONT$0, paramInt);
  ...
  public CTFontName insertNewRFont(int paramInt) {
    synchronized (monitor()) {
      check_orphaned();
      CTFontName cTFontName = null;
      cTFontName = (CTFontName)get_store().insert_element_user(RFONT$0, paramInt);
      return cTFontName;
    } 
  }
  ...
  public void removeRFont(int paramInt) {
    synchronized (monitor()) {
      check_orphaned();
      get_store().remove_element(RFONT$0, paramInt);
    } 
  }
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\spreadsheetml\x2006\main\impl\CTRPrEltImpl.class
