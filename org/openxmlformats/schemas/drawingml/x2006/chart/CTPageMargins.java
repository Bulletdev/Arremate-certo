...
public interface CTPageMargins extends XmlObject {
  ...
  void setL(double paramDouble);
  
  void xsetL(XmlDouble paramXmlDouble);
  
  double getR();
  
  XmlDouble xgetR();
  
  void setR(double paramDouble);
  
  void xsetR(XmlDouble paramXmlDouble);
  
  double getT();
  
  XmlDouble xgetT();
  
  void setT(double paramDouble);
  
  void xsetT(XmlDouble paramXmlDouble);
  
  double getB();
  
  XmlDouble xgetB();
  
  void setB(double paramDouble);
  
  void xsetB(XmlDouble paramXmlDouble);
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\chart\CTPageMargins.class
