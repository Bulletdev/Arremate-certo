...
public class CTNumValImpl extends XmlComplexContentImpl implements CTNumVal {
  ...
  private static final b FORMATCODE$4 = new b("", "formatCode");
  
  public CTNumValImpl(SchemaType paramSchemaType) {
  ...
  public String getFormatCode() {
    synchronized (monitor()) {
      check_orphaned();
      SimpleValue simpleValue = null;
      simpleValue = (SimpleValue)get_store().find_attribute_user(FORMATCODE$4);
      if (simpleValue == null)
        return null; 
      return simpleValue.getStringValue();
    } 
  ...
  public void xsetFormatCode(STXstring paramSTXstring) {
    synchronized (monitor()) {
      ...
      sTXstring = (STXstring)get_store().find_attribute_user(FORMATCODE$4);
      if (sTXstring == null)
        sTXstring = (STXstring)get_store().add_attribute_user(FORMATCODE$4); 
      sTXstring.set((XmlObject)paramSTXstring);
    } 
  }
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\chart\impl\CTNumValImpl.class
