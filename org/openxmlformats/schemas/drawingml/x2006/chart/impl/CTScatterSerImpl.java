...
public class CTScatterSerImpl extends XmlComplexContentImpl implements CTScatterSer {
  ...
  private static final b XVAL$18 = new b("http://schemas.openxmlformats.org/drawingml/2006/chart", "xVal");
  
  private static final b YVAL$20 = new b("http://schemas.openxmlformats.org/drawingml/2006/chart", "yVal");
  ...
  public CTScatterSerImpl(SchemaType paramSchemaType) {
  ...
  public List<CTErrBars> getErrBarsList() {
    synchronized (monitor()) {
      check_orphaned();
      return (List<CTErrBars>)new ErrBarsList(this);
    } 
  }
  ...
  public CTErrBars[] getErrBarsArray() {
    synchronized (monitor()) {
      ...
      CTErrBars[] arrayOfCTErrBars = new CTErrBars[arrayList.size()];
      arrayList.toArray((Object[])arrayOfCTErrBars);
      return arrayOfCTErrBars;
    } 
  }
  
  public CTErrBars getErrBarsArray(int paramInt) {
    synchronized (monitor()) {
      check_orphaned();
      CTErrBars cTErrBars = null;
      cTErrBars = (CTErrBars)get_store().find_element_user(ERRBARS$16, paramInt);
      if (cTErrBars == null)
        throw new IndexOutOfBoundsException(); 
      return cTErrBars;
    } 
  ...
  public void setErrBarsArray(CTErrBars[] paramArrayOfCTErrBars) {
    synchronized (monitor()) {
      check_orphaned();
      arraySetterHelper((XmlObject[])paramArrayOfCTErrBars, ERRBARS$16);
    } 
  }
  
  public void setErrBarsArray(int paramInt, CTErrBars paramCTErrBars) {
    synchronized (monitor()) {
      check_orphaned();
      CTErrBars cTErrBars = null;
      cTErrBars = (CTErrBars)get_store().find_element_user(ERRBARS$16, paramInt);
  ...
  public CTErrBars insertNewErrBars(int paramInt) {
    synchronized (monitor()) {
      check_orphaned();
      CTErrBars cTErrBars = null;
      cTErrBars = (CTErrBars)get_store().insert_element_user(ERRBARS$16, paramInt);
      return cTErrBars;
    } 
  }
  ...
  public void removeErrBars(int paramInt) {
    synchronized (monitor()) {
      check_orphaned();
      get_store().remove_element(ERRBARS$16, paramInt);
    } 
  }
  ...
  public CTAxDataSource getXVal() {
    synchronized (monitor()) {
      ...
      cTAxDataSource = (CTAxDataSource)get_store().find_element_user(XVAL$18, 0);
  ...
  public void setXVal(CTAxDataSource paramCTAxDataSource) {
    synchronized (monitor()) {
      check_orphaned();
      CTAxDataSource cTAxDataSource = null;
      cTAxDataSource = (CTAxDataSource)get_store().find_element_user(XVAL$18, 0);
  ...
  public CTNumDataSource getYVal() {
    synchronized (monitor()) {
      ...
      cTNumDataSource = (CTNumDataSource)get_store().find_element_user(YVAL$20, 0);
  ...
  public void setYVal(CTNumDataSource paramCTNumDataSource) {
    synchronized (monitor()) {
      check_orphaned();
      CTNumDataSource cTNumDataSource = null;
      cTNumDataSource = (CTNumDataSource)get_store().find_element_user(YVAL$20, 0);
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\chart\impl\CTScatterSerImpl.class
