...
public interface CTScRgbColor extends XmlObject {
  ...
  void setG(int paramInt);
  
  void xsetG(STPercentage paramSTPercentage);
  ...
  public static final class Factory {
    ...
    public static CTScRgbColor newInstance(XmlOptions param1XmlOptions) {
      return (CTScRgbColor)POIXMLTypeLoader.newInstance(CTScRgbColor.type, param1XmlOptions);
    }
    
    public static CTScRgbColor parse(String param1String) throws XmlException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1String, CTScRgbColor.type, null);
    }
    
    public static CTScRgbColor parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1String, CTScRgbColor.type, param1XmlOptions);
    }
    
    public static CTScRgbColor parse(File param1File) throws XmlException, IOException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1File, CTScRgbColor.type, null);
    }
    
    public static CTScRgbColor parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1File, CTScRgbColor.type, param1XmlOptions);
    }
    
    public static CTScRgbColor parse(URL param1URL) throws XmlException, IOException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1URL, CTScRgbColor.type, null);
    }
    
    public static CTScRgbColor parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1URL, CTScRgbColor.type, param1XmlOptions);
    }
    
    public static CTScRgbColor parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1InputStream, CTScRgbColor.type, null);
    }
    
    public static CTScRgbColor parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1InputStream, CTScRgbColor.type, param1XmlOptions);
    }
    
    public static CTScRgbColor parse(Reader param1Reader) throws XmlException, IOException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1Reader, CTScRgbColor.type, null);
    }
    
    public static CTScRgbColor parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1Reader, CTScRgbColor.type, param1XmlOptions);
    }
    
    public static CTScRgbColor parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1XMLStreamReader, CTScRgbColor.type, null);
    }
    
    public static CTScRgbColor parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1XMLStreamReader, CTScRgbColor.type, param1XmlOptions);
    }
    
    public static CTScRgbColor parse(Node param1Node) throws XmlException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1Node, CTScRgbColor.type, null);
    }
    
    public static CTScRgbColor parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1Node, CTScRgbColor.type, param1XmlOptions);
    }
    
    public static CTScRgbColor parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1XMLInputStream, CTScRgbColor.type, null);
    }
    
    public static CTScRgbColor parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTScRgbColor)POIXMLTypeLoader.parse(param1XMLInputStream, CTScRgbColor.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTScRgbColor.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTScRgbColor.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\CTScRgbColor.class
