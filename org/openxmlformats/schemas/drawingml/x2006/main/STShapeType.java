...
public interface STShapeType extends XmlToken {
  ...
  public static final class Factory {
    public static STShapeType newValue(Object param1Object) {
      return (STShapeType)STShapeType.type.newValue(param1Object);
    }
    ...
    public static STShapeType newInstance(XmlOptions param1XmlOptions) {
      return (STShapeType)POIXMLTypeLoader.newInstance(STShapeType.type, param1XmlOptions);
    }
    
    public static STShapeType parse(String param1String) throws XmlException {
      return (STShapeType)POIXMLTypeLoader.parse(param1String, STShapeType.type, null);
    }
    
    public static STShapeType parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (STShapeType)POIXMLTypeLoader.parse(param1String, STShapeType.type, param1XmlOptions);
    }
    
    public static STShapeType parse(File param1File) throws XmlException, IOException {
      return (STShapeType)POIXMLTypeLoader.parse(param1File, STShapeType.type, null);
    }
    
    public static STShapeType parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (STShapeType)POIXMLTypeLoader.parse(param1File, STShapeType.type, param1XmlOptions);
    }
    
    public static STShapeType parse(URL param1URL) throws XmlException, IOException {
      return (STShapeType)POIXMLTypeLoader.parse(param1URL, STShapeType.type, null);
    }
    
    public static STShapeType parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (STShapeType)POIXMLTypeLoader.parse(param1URL, STShapeType.type, param1XmlOptions);
    }
    
    public static STShapeType parse(InputStream param1InputStream) throws XmlException, IOException {
      return (STShapeType)POIXMLTypeLoader.parse(param1InputStream, STShapeType.type, null);
    }
    
    public static STShapeType parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (STShapeType)POIXMLTypeLoader.parse(param1InputStream, STShapeType.type, param1XmlOptions);
    }
    
    public static STShapeType parse(Reader param1Reader) throws XmlException, IOException {
      return (STShapeType)POIXMLTypeLoader.parse(param1Reader, STShapeType.type, null);
    }
    
    public static STShapeType parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (STShapeType)POIXMLTypeLoader.parse(param1Reader, STShapeType.type, param1XmlOptions);
    }
    
    public static STShapeType parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (STShapeType)POIXMLTypeLoader.parse(param1XMLStreamReader, STShapeType.type, null);
    }
    
    public static STShapeType parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (STShapeType)POIXMLTypeLoader.parse(param1XMLStreamReader, STShapeType.type, param1XmlOptions);
    }
    
    public static STShapeType parse(Node param1Node) throws XmlException {
      return (STShapeType)POIXMLTypeLoader.parse(param1Node, STShapeType.type, null);
    }
    
    public static STShapeType parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (STShapeType)POIXMLTypeLoader.parse(param1Node, STShapeType.type, param1XmlOptions);
    }
    
    public static STShapeType parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (STShapeType)POIXMLTypeLoader.parse(param1XMLInputStream, STShapeType.type, null);
    }
    
    public static STShapeType parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (STShapeType)POIXMLTypeLoader.parse(param1XMLInputStream, STShapeType.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, STShapeType.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, STShapeType.type, param1XmlOptions);
    }
  }
  ...
  public static final class Enum extends StringEnumAbstractBase {
    ...
    public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table((StringEnumAbstractBase[])new Enum[] { 
          new Enum("line", 1), new Enum("lineInv", 2), new Enum("triangle", 3), new Enum("rtTriangle", 4), new Enum("rect", 5), new Enum("diamond", 6), new Enum("parallelogram", 7), new Enum("trapezoid", 8), new Enum("nonIsoscelesTrapezoid", 9), new Enum("pentagon", 10), 
          new Enum("hexagon", 11), new Enum("heptagon", 12), new Enum("octagon", 13), new Enum("decagon", 14), new Enum("dodecagon", 15), new Enum("star4", 16), new Enum("star5", 17), new Enum("star6", 18), new Enum("star7", 19), new Enum("star8", 20), 
          new Enum("star10", 21), new Enum("star12", 22), new Enum("star16", 23), new Enum("star24", 24), new Enum("star32", 25), new Enum("roundRect", 26), new Enum("round1Rect", 27), new Enum("round2SameRect", 28), new Enum("round2DiagRect", 29), new Enum("snipRoundRect", 30), 
          new Enum("snip1Rect", 31), new Enum("snip2SameRect", 32), new Enum("snip2DiagRect", 33), new Enum("plaque", 34), new Enum("ellipse", 35), new Enum("teardrop", 36), new Enum("homePlate", 37), new Enum("chevron", 38), new Enum("pieWedge", 39), new Enum("pie", 40), 
          new Enum("blockArc", 41), new Enum("donut", 42), new Enum("noSmoking", 43), new Enum("rightArrow", 44), new Enum("leftArrow", 45), new Enum("upArrow", 46), new Enum("downArrow", 47), new Enum("stripedRightArrow", 48), new Enum("notchedRightArrow", 49), new Enum("bentUpArrow", 50), 
          new Enum("leftRightArrow", 51), new Enum("upDownArrow", 52), new Enum("leftUpArrow", 53), new Enum("leftRightUpArrow", 54), new Enum("quadArrow", 55), new Enum("leftArrowCallout", 56), new Enum("rightArrowCallout", 57), new Enum("upArrowCallout", 58), new Enum("downArrowCallout", 59), new Enum("leftRightArrowCallout", 60), 
          new Enum("upDownArrowCallout", 61), new Enum("quadArrowCallout", 62), new Enum("bentArrow", 63), new Enum("uturnArrow", 64), new Enum("circularArrow", 65), new Enum("leftCircularArrow", 66), new Enum("leftRightCircularArrow", 67), new Enum("curvedRightArrow", 68), new Enum("curvedLeftArrow", 69), new Enum("curvedUpArrow", 70), 
          new Enum("curvedDownArrow", 71), new Enum("swooshArrow", 72), new Enum("cube", 73), new Enum("can", 74), new Enum("lightningBolt", 75), new Enum("heart", 76), new Enum("sun", 77), new Enum("moon", 78), new Enum("smileyFace", 79), new Enum("irregularSeal1", 80), 
          new Enum("irregularSeal2", 81), new Enum("foldedCorner", 82), new Enum("bevel", 83), new Enum("frame", 84), new Enum("halfFrame", 85), new Enum("corner", 86), new Enum("diagStripe", 87), new Enum("chord", 88), new Enum("arc", 89), new Enum("leftBracket", 90), 
          new Enum("rightBracket", 91), new Enum("leftBrace", 92), new Enum("rightBrace", 93), new Enum("bracketPair", 94), new Enum("bracePair", 95), new Enum("straightConnector1", 96), new Enum("bentConnector2", 97), new Enum("bentConnector3", 98), new Enum("bentConnector4", 99), new Enum("bentConnector5", 100), 
          new Enum("curvedConnector2", 101), new Enum("curvedConnector3", 102), new Enum("curvedConnector4", 103), new Enum("curvedConnector5", 104), new Enum("callout1", 105), new Enum("callout2", 106), new Enum("callout3", 107), new Enum("accentCallout1", 108), new Enum("accentCallout2", 109), new Enum("accentCallout3", 110), 
          new Enum("borderCallout1", 111), new Enum("borderCallout2", 112), new Enum("borderCallout3", 113), new Enum("accentBorderCallout1", 114), new Enum("accentBorderCallout2", 115), new Enum("accentBorderCallout3", 116), new Enum("wedgeRectCallout", 117), new Enum("wedgeRoundRectCallout", 118), new Enum("wedgeEllipseCallout", 119), new Enum("cloudCallout", 120), 
          new Enum("cloud", 121), new Enum("ribbon", 122), new Enum("ribbon2", 123), new Enum("ellipseRibbon", 124), new Enum("ellipseRibbon2", 125), new Enum("leftRightRibbon", 126), new Enum("verticalScroll", 127), new Enum("horizontalScroll", 128), new Enum("wave", 129), new Enum("doubleWave", 130), 
          new Enum("plus", 131), new Enum("flowChartProcess", 132), new Enum("flowChartDecision", 133), new Enum("flowChartInputOutput", 134), new Enum("flowChartPredefinedProcess", 135), new Enum("flowChartInternalStorage", 136), new Enum("flowChartDocument", 137), new Enum("flowChartMultidocument", 138), new Enum("flowChartTerminator", 139), new Enum("flowChartPreparation", 140), 
          new Enum("flowChartManualInput", 141), new Enum("flowChartManualOperation", 142), new Enum("flowChartConnector", 143), new Enum("flowChartPunchedCard", 144), new Enum("flowChartPunchedTape", 145), new Enum("flowChartSummingJunction", 146), new Enum("flowChartOr", 147), new Enum("flowChartCollate", 148), new Enum("flowChartSort", 149), new Enum("flowChartExtract", 150), 
          new Enum("flowChartMerge", 151), new Enum("flowChartOfflineStorage", 152), new Enum("flowChartOnlineStorage", 153), new Enum("flowChartMagneticTape", 154), new Enum("flowChartMagneticDisk", 155), new Enum("flowChartMagneticDrum", 156), new Enum("flowChartDisplay", 157), new Enum("flowChartDelay", 158), new Enum("flowChartAlternateProcess", 159), new Enum("flowChartOffpageConnector", 160), 
          new Enum("actionButtonBlank", 161), new Enum("actionButtonHome", 162), new Enum("actionButtonHelp", 163), new Enum("actionButtonInformation", 164), new Enum("actionButtonForwardNext", 165), new Enum("actionButtonBackPrevious", 166), new Enum("actionButtonEnd", 167), new Enum("actionButtonBeginning", 168), new Enum("actionButtonReturn", 169), new Enum("actionButtonDocument", 170), 
          new Enum("actionButtonSound", 171), new Enum("actionButtonMovie", 172), new Enum("gear6", 173), new Enum("gear9", 174), new Enum("funnel", 175), new Enum("mathPlus", 176), new Enum("mathMinus", 177), new Enum("mathMultiply", 178), new Enum("mathDivide", 179), new Enum("mathEqual", 180), 
          new Enum("mathNotEqual", 181), new Enum("cornerTabs", 182), new Enum("squareTabs", 183), new Enum("plaqueTabs", 184), new Enum("chartX", 185), new Enum("chartStar", 186), new Enum("chartPlus", 187) });
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\STShapeType.class
