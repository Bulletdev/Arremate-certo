...
public interface CTSRgbColor extends XmlObject {
  ...
  void setVal(byte[] paramArrayOfbyte);
  
  void xsetVal(STHexBinary3 paramSTHexBinary3);
  ...
  public static final class Factory {
    ...
    public static CTSRgbColor newInstance(XmlOptions param1XmlOptions) {
      return (CTSRgbColor)POIXMLTypeLoader.newInstance(CTSRgbColor.type, param1XmlOptions);
    }
    
    public static CTSRgbColor parse(String param1String) throws XmlException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1String, CTSRgbColor.type, null);
    }
    
    public static CTSRgbColor parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1String, CTSRgbColor.type, param1XmlOptions);
    }
    
    public static CTSRgbColor parse(File param1File) throws XmlException, IOException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1File, CTSRgbColor.type, null);
    }
    
    public static CTSRgbColor parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1File, CTSRgbColor.type, param1XmlOptions);
    }
    
    public static CTSRgbColor parse(URL param1URL) throws XmlException, IOException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1URL, CTSRgbColor.type, null);
    }
    
    public static CTSRgbColor parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1URL, CTSRgbColor.type, param1XmlOptions);
    }
    
    public static CTSRgbColor parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1InputStream, CTSRgbColor.type, null);
    }
    
    public static CTSRgbColor parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1InputStream, CTSRgbColor.type, param1XmlOptions);
    }
    
    public static CTSRgbColor parse(Reader param1Reader) throws XmlException, IOException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1Reader, CTSRgbColor.type, null);
    }
    
    public static CTSRgbColor parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1Reader, CTSRgbColor.type, param1XmlOptions);
    }
    
    public static CTSRgbColor parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1XMLStreamReader, CTSRgbColor.type, null);
    }
    
    public static CTSRgbColor parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1XMLStreamReader, CTSRgbColor.type, param1XmlOptions);
    }
    
    public static CTSRgbColor parse(Node param1Node) throws XmlException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1Node, CTSRgbColor.type, null);
    }
    
    public static CTSRgbColor parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1Node, CTSRgbColor.type, param1XmlOptions);
    }
    
    public static CTSRgbColor parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1XMLInputStream, CTSRgbColor.type, null);
    }
    
    public static CTSRgbColor parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTSRgbColor)POIXMLTypeLoader.parse(param1XMLInputStream, CTSRgbColor.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTSRgbColor.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTSRgbColor.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\CTSRgbColor.class
