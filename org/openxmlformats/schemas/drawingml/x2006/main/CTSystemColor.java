...
public interface CTSystemColor extends XmlObject {
  ...
  void setVal(STSystemColorVal.Enum paramEnum);
  
  void xsetVal(STSystemColorVal paramSTSystemColorVal);
  ...
  void setLastClr(byte[] paramArrayOfbyte);
  
  void xsetLastClr(STHexBinary3 paramSTHexBinary3);
  ...
  public static final class Factory {
    ...
    public static CTSystemColor newInstance(XmlOptions param1XmlOptions) {
      return (CTSystemColor)POIXMLTypeLoader.newInstance(CTSystemColor.type, param1XmlOptions);
    }
    
    public static CTSystemColor parse(String param1String) throws XmlException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1String, CTSystemColor.type, null);
    }
    
    public static CTSystemColor parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1String, CTSystemColor.type, param1XmlOptions);
    }
    
    public static CTSystemColor parse(File param1File) throws XmlException, IOException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1File, CTSystemColor.type, null);
    }
    
    public static CTSystemColor parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1File, CTSystemColor.type, param1XmlOptions);
    }
    
    public static CTSystemColor parse(URL param1URL) throws XmlException, IOException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1URL, CTSystemColor.type, null);
    }
    
    public static CTSystemColor parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1URL, CTSystemColor.type, param1XmlOptions);
    }
    
    public static CTSystemColor parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1InputStream, CTSystemColor.type, null);
    }
    
    public static CTSystemColor parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1InputStream, CTSystemColor.type, param1XmlOptions);
    }
    
    public static CTSystemColor parse(Reader param1Reader) throws XmlException, IOException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1Reader, CTSystemColor.type, null);
    }
    
    public static CTSystemColor parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1Reader, CTSystemColor.type, param1XmlOptions);
    }
    
    public static CTSystemColor parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1XMLStreamReader, CTSystemColor.type, null);
    }
    
    public static CTSystemColor parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1XMLStreamReader, CTSystemColor.type, param1XmlOptions);
    }
    
    public static CTSystemColor parse(Node param1Node) throws XmlException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1Node, CTSystemColor.type, null);
    }
    
    public static CTSystemColor parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1Node, CTSystemColor.type, param1XmlOptions);
    }
    
    public static CTSystemColor parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1XMLInputStream, CTSystemColor.type, null);
    }
    
    public static CTSystemColor parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTSystemColor)POIXMLTypeLoader.parse(param1XMLInputStream, CTSystemColor.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTSystemColor.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTSystemColor.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\CTSystemColor.class
