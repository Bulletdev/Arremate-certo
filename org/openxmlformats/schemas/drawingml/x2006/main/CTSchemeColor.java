...
public interface CTSchemeColor extends XmlObject {
  ...
  void setVal(STSchemeColorVal.Enum paramEnum);
  
  void xsetVal(STSchemeColorVal paramSTSchemeColorVal);
  ...
  public static final class Factory {
    ...
    public static CTSchemeColor newInstance(XmlOptions param1XmlOptions) {
      return (CTSchemeColor)POIXMLTypeLoader.newInstance(CTSchemeColor.type, param1XmlOptions);
    }
    
    public static CTSchemeColor parse(String param1String) throws XmlException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1String, CTSchemeColor.type, null);
    }
    
    public static CTSchemeColor parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1String, CTSchemeColor.type, param1XmlOptions);
    }
    
    public static CTSchemeColor parse(File param1File) throws XmlException, IOException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1File, CTSchemeColor.type, null);
    }
    
    public static CTSchemeColor parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1File, CTSchemeColor.type, param1XmlOptions);
    }
    
    public static CTSchemeColor parse(URL param1URL) throws XmlException, IOException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1URL, CTSchemeColor.type, null);
    }
    
    public static CTSchemeColor parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1URL, CTSchemeColor.type, param1XmlOptions);
    }
    
    public static CTSchemeColor parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1InputStream, CTSchemeColor.type, null);
    }
    
    public static CTSchemeColor parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1InputStream, CTSchemeColor.type, param1XmlOptions);
    }
    
    public static CTSchemeColor parse(Reader param1Reader) throws XmlException, IOException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1Reader, CTSchemeColor.type, null);
    }
    
    public static CTSchemeColor parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1Reader, CTSchemeColor.type, param1XmlOptions);
    }
    
    public static CTSchemeColor parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1XMLStreamReader, CTSchemeColor.type, null);
    }
    
    public static CTSchemeColor parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1XMLStreamReader, CTSchemeColor.type, param1XmlOptions);
    }
    
    public static CTSchemeColor parse(Node param1Node) throws XmlException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1Node, CTSchemeColor.type, null);
    }
    
    public static CTSchemeColor parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1Node, CTSchemeColor.type, param1XmlOptions);
    }
    
    public static CTSchemeColor parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1XMLInputStream, CTSchemeColor.type, null);
    }
    
    public static CTSchemeColor parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTSchemeColor)POIXMLTypeLoader.parse(param1XMLInputStream, CTSchemeColor.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTSchemeColor.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTSchemeColor.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\CTSchemeColor.class
