...
public class CTSchemeColorImpl extends XmlComplexContentImpl implements CTSchemeColor {
  ...
  public CTSchemeColorImpl(SchemaType paramSchemaType) {
  ...
  public void setVal(STSchemeColorVal.Enum paramEnum) {
    synchronized (monitor()) {
      check_orphaned();
      SimpleValue simpleValue = null;
      simpleValue = (SimpleValue)get_store().find_attribute_user(VAL$56);
  ...
  public void xsetVal(STSchemeColorVal paramSTSchemeColorVal) {
    synchronized (monitor()) {
      check_orphaned();
      STSchemeColorVal sTSchemeColorVal = null;
      sTSchemeColorVal = (STSchemeColorVal)get_store().find_attribute_user(VAL$56);
      if (sTSchemeColorVal == null)
        sTSchemeColorVal = (STSchemeColorVal)get_store().add_attribute_user(VAL$56); 
      sTSchemeColorVal.set((XmlObject)paramSTSchemeColorVal);
    } 
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\impl\CTSchemeColorImpl.class
