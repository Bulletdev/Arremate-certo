...
public class CTScRgbColorImpl extends XmlComplexContentImpl implements CTScRgbColor {
  ...
  private static final b R$56 = new b("", "r");
  
  private static final b G$58 = new b("", "g");
  
  private static final b B$60 = new b("", "b");
  
  public CTScRgbColorImpl(SchemaType paramSchemaType) {
  ...
  public int getR() {
    synchronized (monitor()) {
      ...
      simpleValue = (SimpleValue)get_store().find_attribute_user(R$56);
      if (simpleValue == null)
        return 0; 
  ...
  public void xsetR(STPercentage paramSTPercentage) {
    synchronized (monitor()) {
      ...
      if (sTPercentage == null)
        sTPercentage = (STPercentage)get_store().add_attribute_user(R$56); 
  ...
  public int getG() {
    synchronized (monitor()) {
      check_orphaned();
      SimpleValue simpleValue = null;
      simpleValue = (SimpleValue)get_store().find_attribute_user(G$58);
      if (simpleValue == null)
        return 0; 
      return simpleValue.getIntValue();
    } 
  ...
  public void xsetG(STPercentage paramSTPercentage) {
    synchronized (monitor()) {
      check_orphaned();
      STPercentage sTPercentage = null;
      sTPercentage = (STPercentage)get_store().find_attribute_user(G$58);
      if (sTPercentage == null)
        sTPercentage = (STPercentage)get_store().add_attribute_user(G$58); 
      sTPercentage.set((XmlObject)paramSTPercentage);
    } 
  }
  ...
  public int getB() {
    synchronized (monitor()) {
      check_orphaned();
      SimpleValue simpleValue = null;
      simpleValue = (SimpleValue)get_store().find_attribute_user(B$60);
      if (simpleValue == null)
        return 0; 
      return simpleValue.getIntValue();
    } 
  ...
  public void xsetB(STPercentage paramSTPercentage) {
    synchronized (monitor()) {
      ...
      sTPercentage = (STPercentage)get_store().find_attribute_user(B$60);
      if (sTPercentage == null)
        sTPercentage = (STPercentage)get_store().add_attribute_user(B$60); 
      sTPercentage.set((XmlObject)paramSTPercentage);
    } 
  }
}
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\impl\CTScRgbColorImpl.class
