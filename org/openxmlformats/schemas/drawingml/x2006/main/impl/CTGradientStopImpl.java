...
public class CTGradientStopImpl extends XmlComplexContentImpl implements CTGradientStop {
  ...
  private static final b POS$12 = new b("", "pos");
  
  public CTGradientStopImpl(SchemaType paramSchemaType) {
  ...
  public int getPos() {
    synchronized (monitor()) {
      ...
      simpleValue = (SimpleValue)get_store().find_attribute_user(POS$12);
      if (simpleValue == null)
        return 0; 
  ...
  public void xsetPos(STPositiveFixedPercentage paramSTPositiveFixedPercentage) {
    synchronized (monitor()) {
      check_orphaned();
      STPositiveFixedPercentage sTPositiveFixedPercentage = null;
      sTPositiveFixedPercentage = (STPositiveFixedPercentage)get_store().find_attribute_user(POS$12);
      if (sTPositiveFixedPercentage == null)
        sTPositiveFixedPercentage = (STPositiveFixedPercentage)get_store().add_attribute_user(POS$12); 
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\impl\CTGradientStopImpl.class
