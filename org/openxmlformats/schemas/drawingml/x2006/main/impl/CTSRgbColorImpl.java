...
public class CTSRgbColorImpl extends XmlComplexContentImpl implements CTSRgbColor {
  ...
  public CTSRgbColorImpl(SchemaType paramSchemaType) {
  ...
  public void xsetVal(STHexBinary3 paramSTHexBinary3) {
    synchronized (monitor()) {
      check_orphaned();
      STHexBinary3 sTHexBinary3 = null;
      sTHexBinary3 = (STHexBinary3)get_store().find_attribute_user(VAL$56);
      if (sTHexBinary3 == null)
        sTHexBinary3 = (STHexBinary3)get_store().add_attribute_user(VAL$56); 
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\impl\CTSRgbColorImpl.class
