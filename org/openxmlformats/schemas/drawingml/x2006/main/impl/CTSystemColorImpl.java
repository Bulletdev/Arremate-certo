...
public class CTSystemColorImpl extends XmlComplexContentImpl implements CTSystemColor {
  ...
  private static final b LASTCLR$58 = new b("", "lastClr");
  
  public CTSystemColorImpl(SchemaType paramSchemaType) {
  ...
  public void setVal(STSystemColorVal.Enum paramEnum) {
    synchronized (monitor()) {
      check_orphaned();
      SimpleValue simpleValue = null;
      simpleValue = (SimpleValue)get_store().find_attribute_user(VAL$56);
  ...
  public void xsetVal(STSystemColorVal paramSTSystemColorVal) {
    synchronized (monitor()) {
      check_orphaned();
      STSystemColorVal sTSystemColorVal = null;
      sTSystemColorVal = (STSystemColorVal)get_store().find_attribute_user(VAL$56);
      if (sTSystemColorVal == null)
        sTSystemColorVal = (STSystemColorVal)get_store().add_attribute_user(VAL$56); 
      sTSystemColorVal.set((XmlObject)paramSTSystemColorVal);
    } 
  }
  ...
  public byte[] getLastClr() {
    synchronized (monitor()) {
      check_orphaned();
      SimpleValue simpleValue = null;
      simpleValue = (SimpleValue)get_store().find_attribute_user(LASTCLR$58);
      if (simpleValue == null)
        return null; 
  ...
  public void xsetLastClr(STHexBinary3 paramSTHexBinary3) {
    synchronized (monitor()) {
      check_orphaned();
      STHexBinary3 sTHexBinary3 = null;
      sTHexBinary3 = (STHexBinary3)get_store().find_attribute_user(LASTCLR$58);
      if (sTHexBinary3 == null)
        sTHexBinary3 = (STHexBinary3)get_store().add_attribute_user(LASTCLR$58); 
      sTHexBinary3.set((XmlObject)paramSTHexBinary3);
    } 
  }
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\impl\CTSystemColorImpl.class
