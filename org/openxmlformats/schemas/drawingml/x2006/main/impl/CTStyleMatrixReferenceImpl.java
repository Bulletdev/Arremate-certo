...
public class CTStyleMatrixReferenceImpl extends XmlComplexContentImpl implements CTStyleMatrixReference {
  ...
  public CTStyleMatrixReferenceImpl(SchemaType paramSchemaType) {
  ...
  public void xsetIdx(STStyleMatrixColumnIndex paramSTStyleMatrixColumnIndex) {
    synchronized (monitor()) {
      check_orphaned();
      STStyleMatrixColumnIndex sTStyleMatrixColumnIndex = null;
      sTStyleMatrixColumnIndex = (STStyleMatrixColumnIndex)get_store().find_attribute_user(IDX$12);
      if (sTStyleMatrixColumnIndex == null)
        sTStyleMatrixColumnIndex = (STStyleMatrixColumnIndex)get_store().add_attribute_user(IDX$12); 
      sTStyleMatrixColumnIndex.set((XmlObject)paramSTStyleMatrixColumnIndex);
    } 
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\impl\CTStyleMatrixReferenceImpl.class
