...
public interface CTTable extends XmlObject {
  ...
  void setTblPr(CTTableProperties paramCTTableProperties);
  ...
  void setTblGrid(CTTableGrid paramCTTableGrid);
  ...
  CTTableRow getTrArray(int paramInt);
  
  int sizeOfTrArray();
  
  void setTrArray(CTTableRow[] paramArrayOfCTTableRow);
  
  void setTrArray(int paramInt, CTTableRow paramCTTableRow);
  
  CTTableRow insertNewTr(int paramInt);
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\CTTable.class
