...
public interface CTPath2DClose extends XmlObject {
  ...
  public static final class Factory {
    ...
    public static CTPath2DClose newInstance(XmlOptions param1XmlOptions) {
      return (CTPath2DClose)POIXMLTypeLoader.newInstance(CTPath2DClose.type, param1XmlOptions);
    }
    
    public static CTPath2DClose parse(String param1String) throws XmlException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1String, CTPath2DClose.type, null);
    }
    
    public static CTPath2DClose parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1String, CTPath2DClose.type, param1XmlOptions);
    }
    
    public static CTPath2DClose parse(File param1File) throws XmlException, IOException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1File, CTPath2DClose.type, null);
    }
    
    public static CTPath2DClose parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1File, CTPath2DClose.type, param1XmlOptions);
    }
    
    public static CTPath2DClose parse(URL param1URL) throws XmlException, IOException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1URL, CTPath2DClose.type, null);
    }
    
    public static CTPath2DClose parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1URL, CTPath2DClose.type, param1XmlOptions);
    }
    
    public static CTPath2DClose parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1InputStream, CTPath2DClose.type, null);
    }
    ...
    public static CTPath2DClose parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1InputStream, CTPath2DClose.type, param1XmlOptions);
    }
    
    public static CTPath2DClose parse(Reader param1Reader) throws XmlException, IOException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1Reader, CTPath2DClose.type, null);
    }
    
    public static CTPath2DClose parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1Reader, CTPath2DClose.type, param1XmlOptions);
    }
    
    public static CTPath2DClose parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1XMLStreamReader, CTPath2DClose.type, null);
    }
    
    public static CTPath2DClose parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1XMLStreamReader, CTPath2DClose.type, param1XmlOptions);
    }
    
    public static CTPath2DClose parse(Node param1Node) throws XmlException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1Node, CTPath2DClose.type, null);
    }
    
    public static CTPath2DClose parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1Node, CTPath2DClose.type, param1XmlOptions);
    }
    
    public static CTPath2DClose parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1XMLInputStream, CTPath2DClose.type, null);
    }
    ...
    public static CTPath2DClose parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTPath2DClose)POIXMLTypeLoader.parse(param1XMLInputStream, CTPath2DClose.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTPath2DClose.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTPath2DClose.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\drawingml\x2006\main\CTPath2DClose.class
