...
public interface CTSmartTagRun extends XmlObject {
  ...
  void xsetUri(STString paramSTString);
  ...
  void setElement(String paramString);
  
  void xsetElement(STString paramSTString);
  ...
  public static final class Factory {
    ...
    public static CTSmartTagRun newInstance(XmlOptions param1XmlOptions) {
      return (CTSmartTagRun)POIXMLTypeLoader.newInstance(CTSmartTagRun.type, param1XmlOptions);
    }
    
    public static CTSmartTagRun parse(String param1String) throws XmlException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1String, CTSmartTagRun.type, null);
    }
    
    public static CTSmartTagRun parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1String, CTSmartTagRun.type, param1XmlOptions);
    }
    
    public static CTSmartTagRun parse(File param1File) throws XmlException, IOException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1File, CTSmartTagRun.type, null);
    }
    
    public static CTSmartTagRun parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1File, CTSmartTagRun.type, param1XmlOptions);
    }
    
    public static CTSmartTagRun parse(URL param1URL) throws XmlException, IOException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1URL, CTSmartTagRun.type, null);
    }
    
    public static CTSmartTagRun parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1URL, CTSmartTagRun.type, param1XmlOptions);
    }
    
    public static CTSmartTagRun parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1InputStream, CTSmartTagRun.type, null);
    }
    
    public static CTSmartTagRun parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1InputStream, CTSmartTagRun.type, param1XmlOptions);
    }
    
    public static CTSmartTagRun parse(Reader param1Reader) throws XmlException, IOException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1Reader, CTSmartTagRun.type, null);
    }
    
    public static CTSmartTagRun parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1Reader, CTSmartTagRun.type, param1XmlOptions);
    }
    
    public static CTSmartTagRun parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1XMLStreamReader, CTSmartTagRun.type, null);
    }
    
    public static CTSmartTagRun parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1XMLStreamReader, CTSmartTagRun.type, param1XmlOptions);
    }
    
    public static CTSmartTagRun parse(Node param1Node) throws XmlException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1Node, CTSmartTagRun.type, null);
    }
    
    public static CTSmartTagRun parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1Node, CTSmartTagRun.type, param1XmlOptions);
    }
    
    public static CTSmartTagRun parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1XMLInputStream, CTSmartTagRun.type, null);
    }
    
    public static CTSmartTagRun parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTSmartTagRun)POIXMLTypeLoader.parse(param1XMLInputStream, CTSmartTagRun.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTSmartTagRun.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTSmartTagRun.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\CTSmartTagRun.class
