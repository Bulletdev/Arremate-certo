...
public class CTFtnEdnImpl extends XmlComplexContentImpl implements CTFtnEdn {
  ...
  private static final b TYPE$60 = new b("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "type");
  
  private static final b ID$62 = new b("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "id");
  
  public CTFtnEdnImpl(SchemaType paramSchemaType) {
  ...
  public void setType(STFtnEdn.Enum paramEnum) {
    synchronized (monitor()) {
      check_orphaned();
      SimpleValue simpleValue = null;
      simpleValue = (SimpleValue)get_store().find_attribute_user(TYPE$60);
  ...
  public void xsetType(STFtnEdn paramSTFtnEdn) {
    synchronized (monitor()) {
      check_orphaned();
      STFtnEdn sTFtnEdn = null;
      sTFtnEdn = (STFtnEdn)get_store().find_attribute_user(TYPE$60);
      if (sTFtnEdn == null)
        sTFtnEdn = (STFtnEdn)get_store().add_attribute_user(TYPE$60); 
      sTFtnEdn.set((XmlObject)paramSTFtnEdn);
    } 
  }
  ...
  public BigInteger getId() {
    synchronized (monitor()) {
      check_orphaned();
      SimpleValue simpleValue = null;
      simpleValue = (SimpleValue)get_store().find_attribute_user(ID$62);
      if (simpleValue == null)
        return null; 
  ...
  public void xsetId(STDecimalNumber paramSTDecimalNumber) {
    synchronized (monitor()) {
      ...
      if (sTDecimalNumber == null)
        sTDecimalNumber = (STDecimalNumber)get_store().add_attribute_user(ID$62); 
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\impl\CTFtnEdnImpl.class
