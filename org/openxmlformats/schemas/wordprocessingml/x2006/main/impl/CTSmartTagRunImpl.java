...
public class CTSmartTagRunImpl extends XmlComplexContentImpl implements CTSmartTagRun {
  private static final b SMARTTAGPR$0 = new b("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "smartTagPr");
  ...
  private static final b URI$66 = new b("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "uri");
  
  private static final b ELEMENT$68 = new b("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "element");
  
  public CTSmartTagRunImpl(SchemaType paramSchemaType) {
  ...
  public CTSmartTagPr getSmartTagPr() {
    synchronized (monitor()) {
      ...
      cTSmartTagPr = (CTSmartTagPr)get_store().find_element_user(SMARTTAGPR$0, 0);
  ...
  public String getUri() {
    synchronized (monitor()) {
      ...
      simpleValue = (SimpleValue)get_store().find_attribute_user(URI$66);
      if (simpleValue == null)
        return null; 
  ...
  public void xsetUri(STString paramSTString) {
    synchronized (monitor()) {
      check_orphaned();
      STString sTString = null;
      sTString = (STString)get_store().find_attribute_user(URI$66);
      if (sTString == null)
        sTString = (STString)get_store().add_attribute_user(URI$66); 
  ...
  public String getElement() {
    synchronized (monitor()) {
      check_orphaned();
      SimpleValue simpleValue = null;
      simpleValue = (SimpleValue)get_store().find_attribute_user(ELEMENT$68);
      if (simpleValue == null)
        return null; 
      return simpleValue.getStringValue();
    } 
  ...
  public void setElement(String paramString) {
    synchronized (monitor()) {
      check_orphaned();
      SimpleValue simpleValue = null;
      simpleValue = (SimpleValue)get_store().find_attribute_user(ELEMENT$68);
  ...
  public void xsetElement(STString paramSTString) {
    synchronized (monitor()) {
      check_orphaned();
      STString sTString = null;
      sTString = (STString)get_store().find_attribute_user(ELEMENT$68);
      if (sTString == null)
        sTString = (STString)get_store().add_attribute_user(ELEMENT$68); 
      sTString.set((XmlObject)paramSTString);
    } 
  }
}
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\impl\CTSmartTagRunImpl.class
