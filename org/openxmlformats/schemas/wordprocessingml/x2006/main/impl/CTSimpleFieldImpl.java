...
public class CTSimpleFieldImpl extends XmlComplexContentImpl implements CTSimpleField {
  ...
  private static final b INSTR$66 = new b("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "instr");
  
  private static final b FLDLOCK$68 = new b("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "fldLock");
  
  private static final b DIRTY$70 = new b("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "dirty");
  
  public CTSimpleFieldImpl(SchemaType paramSchemaType) {
  ...
  public String getInstr() {
    synchronized (monitor()) {
      ...
      simpleValue = (SimpleValue)get_store().find_attribute_user(INSTR$66);
      if (simpleValue == null)
        return null; 
  ...
  public void xsetInstr(STString paramSTString) {
    synchronized (monitor()) {
      check_orphaned();
      STString sTString = null;
      sTString = (STString)get_store().find_attribute_user(INSTR$66);
      if (sTString == null)
        sTString = (STString)get_store().add_attribute_user(INSTR$66); 
  ...
  public STOnOff.Enum getFldLock() {
    synchronized (monitor()) {
      check_orphaned();
      SimpleValue simpleValue = null;
      simpleValue = (SimpleValue)get_store().find_attribute_user(FLDLOCK$68);
      if (simpleValue == null)
        return null; 
  ...
  public boolean isSetFldLock() {
    synchronized (monitor()) {
      check_orphaned();
      return (get_store().find_attribute_user(FLDLOCK$68) != null);
    } 
  }
  ...
  public void xsetFldLock(STOnOff paramSTOnOff) {
    synchronized (monitor()) {
      ...
      sTOnOff = (STOnOff)get_store().find_attribute_user(FLDLOCK$68);
      if (sTOnOff == null)
        sTOnOff = (STOnOff)get_store().add_attribute_user(FLDLOCK$68); 
  ...
  public void xsetDirty(STOnOff paramSTOnOff) {
    synchronized (monitor()) {
      ...
      sTOnOff = (STOnOff)get_store().find_attribute_user(DIRTY$70);
      if (sTOnOff == null)
        sTOnOff = (STOnOff)get_store().add_attribute_user(DIRTY$70); 
      sTOnOff.set((XmlObject)paramSTOnOff);
    } 
  }
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\impl\CTSimpleFieldImpl.class
