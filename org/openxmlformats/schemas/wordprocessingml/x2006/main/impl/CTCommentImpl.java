...
public class CTCommentImpl extends CTTrackChangeImpl implements CTComment {
  ...
  private static final b INITIALS$60 = new b("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "initials");
  ...
  public String getInitials() {
    synchronized (monitor()) {
      ...
      simpleValue = (SimpleValue)get_store().find_attribute_user(INITIALS$60);
      if (simpleValue == null)
        return null; 
  ...
  public void xsetInitials(STString paramSTString) {
    synchronized (monitor()) {
      check_orphaned();
      STString sTString = null;
      sTString = (STString)get_store().find_attribute_user(INITIALS$60);
      if (sTString == null)
        sTString = (STString)get_store().add_attribute_user(INITIALS$60); 
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\impl\CTCommentImpl.class
