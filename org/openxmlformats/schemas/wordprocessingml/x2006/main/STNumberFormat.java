...
public interface STNumberFormat extends XmlString {
  ...
  public static final class Factory {
    public static STNumberFormat newValue(Object param1Object) {
      return (STNumberFormat)STNumberFormat.type.newValue(param1Object);
    }
    ...
    public static STNumberFormat newInstance(XmlOptions param1XmlOptions) {
      return (STNumberFormat)POIXMLTypeLoader.newInstance(STNumberFormat.type, param1XmlOptions);
    }
    
    public static STNumberFormat parse(String param1String) throws XmlException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1String, STNumberFormat.type, null);
    }
    
    public static STNumberFormat parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1String, STNumberFormat.type, param1XmlOptions);
    }
    
    public static STNumberFormat parse(File param1File) throws XmlException, IOException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1File, STNumberFormat.type, null);
    }
    
    public static STNumberFormat parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1File, STNumberFormat.type, param1XmlOptions);
    }
    
    public static STNumberFormat parse(URL param1URL) throws XmlException, IOException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1URL, STNumberFormat.type, null);
    }
    
    public static STNumberFormat parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1URL, STNumberFormat.type, param1XmlOptions);
    }
    
    public static STNumberFormat parse(InputStream param1InputStream) throws XmlException, IOException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1InputStream, STNumberFormat.type, null);
    }
    
    public static STNumberFormat parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1InputStream, STNumberFormat.type, param1XmlOptions);
    }
    
    public static STNumberFormat parse(Reader param1Reader) throws XmlException, IOException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1Reader, STNumberFormat.type, null);
    }
    
    public static STNumberFormat parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1Reader, STNumberFormat.type, param1XmlOptions);
    }
    
    public static STNumberFormat parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1XMLStreamReader, STNumberFormat.type, null);
    }
    
    public static STNumberFormat parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1XMLStreamReader, STNumberFormat.type, param1XmlOptions);
    }
    
    public static STNumberFormat parse(Node param1Node) throws XmlException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1Node, STNumberFormat.type, null);
    }
    
    public static STNumberFormat parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1Node, STNumberFormat.type, param1XmlOptions);
    }
    
    public static STNumberFormat parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1XMLInputStream, STNumberFormat.type, null);
    }
    
    public static STNumberFormat parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (STNumberFormat)POIXMLTypeLoader.parse(param1XMLInputStream, STNumberFormat.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, STNumberFormat.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, STNumberFormat.type, param1XmlOptions);
    }
  }
  ...
  public static final class Enum extends StringEnumAbstractBase {
    ...
    public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table((StringEnumAbstractBase[])new Enum[] { 
          new Enum("decimal", 1), new Enum("upperRoman", 2), new Enum("lowerRoman", 3), new Enum("upperLetter", 4), new Enum("lowerLetter", 5), new Enum("ordinal", 6), new Enum("cardinalText", 7), new Enum("ordinalText", 8), new Enum("hex", 9), new Enum("chicago", 10), 
          new Enum("ideographDigital", 11), new Enum("japaneseCounting", 12), new Enum("aiueo", 13), new Enum("iroha", 14), new Enum("decimalFullWidth", 15), new Enum("decimalHalfWidth", 16), new Enum("japaneseLegal", 17), new Enum("japaneseDigitalTenThousand", 18), new Enum("decimalEnclosedCircle", 19), new Enum("decimalFullWidth2", 20), 
          new Enum("aiueoFullWidth", 21), new Enum("irohaFullWidth", 22), new Enum("decimalZero", 23), new Enum("bullet", 24), new Enum("ganada", 25), new Enum("chosung", 26), new Enum("decimalEnclosedFullstop", 27), new Enum("decimalEnclosedParen", 28), new Enum("decimalEnclosedCircleChinese", 29), new Enum("ideographEnclosedCircle", 30), 
          new Enum("ideographTraditional", 31), new Enum("ideographZodiac", 32), new Enum("ideographZodiacTraditional", 33), new Enum("taiwaneseCounting", 34), new Enum("ideographLegalTraditional", 35), new Enum("taiwaneseCountingThousand", 36), new Enum("taiwaneseDigital", 37), new Enum("chineseCounting", 38), new Enum("chineseLegalSimplified", 39), new Enum("chineseCountingThousand", 40), 
          new Enum("koreanDigital", 41), new Enum("koreanCounting", 42), new Enum("koreanLegal", 43), new Enum("koreanDigital2", 44), new Enum("vietnameseCounting", 45), new Enum("russianLower", 46), new Enum("russianUpper", 47), new Enum("none", 48), new Enum("numberInDash", 49), new Enum("hebrew1", 50), 
          new Enum("hebrew2", 51), new Enum("arabicAlpha", 52), new Enum("arabicAbjad", 53), new Enum("hindiVowels", 54), new Enum("hindiConsonants", 55), new Enum("hindiNumbers", 56), new Enum("hindiCounting", 57), new Enum("thaiLetters", 58), new Enum("thaiNumbers", 59), new Enum("thaiCounting", 60) });
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\STNumberFormat.class
