...
public interface CTTc extends XmlObject {
  ...
  public static final class Factory {
    ...
    public static CTTc newInstance(XmlOptions param1XmlOptions) {
      return (CTTc)POIXMLTypeLoader.newInstance(CTTc.type, param1XmlOptions);
    }
    
    public static CTTc parse(String param1String) throws XmlException {
      return (CTTc)POIXMLTypeLoader.parse(param1String, CTTc.type, null);
    }
    
    public static CTTc parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTTc)POIXMLTypeLoader.parse(param1String, CTTc.type, param1XmlOptions);
    }
    
    public static CTTc parse(File param1File) throws XmlException, IOException {
      return (CTTc)POIXMLTypeLoader.parse(param1File, CTTc.type, null);
    }
    
    public static CTTc parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTTc)POIXMLTypeLoader.parse(param1File, CTTc.type, param1XmlOptions);
    }
    
    public static CTTc parse(URL param1URL) throws XmlException, IOException {
      return (CTTc)POIXMLTypeLoader.parse(param1URL, CTTc.type, null);
    }
    
    public static CTTc parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTTc)POIXMLTypeLoader.parse(param1URL, CTTc.type, param1XmlOptions);
    }
    
    public static CTTc parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTTc)POIXMLTypeLoader.parse(param1InputStream, CTTc.type, null);
    }
    
    public static CTTc parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTTc)POIXMLTypeLoader.parse(param1InputStream, CTTc.type, param1XmlOptions);
    }
    
    public static CTTc parse(Reader param1Reader) throws XmlException, IOException {
      return (CTTc)POIXMLTypeLoader.parse(param1Reader, CTTc.type, null);
    }
    
    public static CTTc parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTTc)POIXMLTypeLoader.parse(param1Reader, CTTc.type, param1XmlOptions);
    }
    
    public static CTTc parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTTc)POIXMLTypeLoader.parse(param1XMLStreamReader, CTTc.type, null);
    }
    
    public static CTTc parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTTc)POIXMLTypeLoader.parse(param1XMLStreamReader, CTTc.type, param1XmlOptions);
    }
    
    public static CTTc parse(Node param1Node) throws XmlException {
      return (CTTc)POIXMLTypeLoader.parse(param1Node, CTTc.type, null);
    }
    
    public static CTTc parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTTc)POIXMLTypeLoader.parse(param1Node, CTTc.type, param1XmlOptions);
    }
    
    public static CTTc parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTTc)POIXMLTypeLoader.parse(param1XMLInputStream, CTTc.type, null);
    }
    
    public static CTTc parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTTc)POIXMLTypeLoader.parse(param1XMLInputStream, CTTc.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTTc.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTTc.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\CTTc.class
