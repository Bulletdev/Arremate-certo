...
public interface STBorder extends XmlString {
  ...
  public static final class Factory {
    public static STBorder newValue(Object param1Object) {
      return (STBorder)STBorder.type.newValue(param1Object);
    }
    ...
    public static STBorder newInstance(XmlOptions param1XmlOptions) {
      return (STBorder)POIXMLTypeLoader.newInstance(STBorder.type, param1XmlOptions);
    }
    
    public static STBorder parse(String param1String) throws XmlException {
      return (STBorder)POIXMLTypeLoader.parse(param1String, STBorder.type, null);
    }
    
    public static STBorder parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (STBorder)POIXMLTypeLoader.parse(param1String, STBorder.type, param1XmlOptions);
    }
    
    public static STBorder parse(File param1File) throws XmlException, IOException {
      return (STBorder)POIXMLTypeLoader.parse(param1File, STBorder.type, null);
    }
    
    public static STBorder parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (STBorder)POIXMLTypeLoader.parse(param1File, STBorder.type, param1XmlOptions);
    }
    
    public static STBorder parse(URL param1URL) throws XmlException, IOException {
      return (STBorder)POIXMLTypeLoader.parse(param1URL, STBorder.type, null);
    }
    
    public static STBorder parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (STBorder)POIXMLTypeLoader.parse(param1URL, STBorder.type, param1XmlOptions);
    }
    
    public static STBorder parse(InputStream param1InputStream) throws XmlException, IOException {
      return (STBorder)POIXMLTypeLoader.parse(param1InputStream, STBorder.type, null);
    }
    
    public static STBorder parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (STBorder)POIXMLTypeLoader.parse(param1InputStream, STBorder.type, param1XmlOptions);
    }
    
    public static STBorder parse(Reader param1Reader) throws XmlException, IOException {
      return (STBorder)POIXMLTypeLoader.parse(param1Reader, STBorder.type, null);
    }
    
    public static STBorder parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (STBorder)POIXMLTypeLoader.parse(param1Reader, STBorder.type, param1XmlOptions);
    }
    
    public static STBorder parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (STBorder)POIXMLTypeLoader.parse(param1XMLStreamReader, STBorder.type, null);
    }
    
    public static STBorder parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (STBorder)POIXMLTypeLoader.parse(param1XMLStreamReader, STBorder.type, param1XmlOptions);
    }
    
    public static STBorder parse(Node param1Node) throws XmlException {
      return (STBorder)POIXMLTypeLoader.parse(param1Node, STBorder.type, null);
    }
    
    public static STBorder parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (STBorder)POIXMLTypeLoader.parse(param1Node, STBorder.type, param1XmlOptions);
    }
    
    public static STBorder parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (STBorder)POIXMLTypeLoader.parse(param1XMLInputStream, STBorder.type, null);
    }
    
    public static STBorder parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (STBorder)POIXMLTypeLoader.parse(param1XMLInputStream, STBorder.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, STBorder.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, STBorder.type, param1XmlOptions);
    }
  }
  ...
  public static final class Enum extends StringEnumAbstractBase {
    ...
    public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table((StringEnumAbstractBase[])new Enum[] { 
          new Enum("nil", 1), new Enum("none", 2), new Enum("single", 3), new Enum("thick", 4), new Enum("double", 5), new Enum("dotted", 6), new Enum("dashed", 7), new Enum("dotDash", 8), new Enum("dotDotDash", 9), new Enum("triple", 10), 
          new Enum("thinThickSmallGap", 11), new Enum("thickThinSmallGap", 12), new Enum("thinThickThinSmallGap", 13), new Enum("thinThickMediumGap", 14), new Enum("thickThinMediumGap", 15), new Enum("thinThickThinMediumGap", 16), new Enum("thinThickLargeGap", 17), new Enum("thickThinLargeGap", 18), new Enum("thinThickThinLargeGap", 19), new Enum("wave", 20), 
          new Enum("doubleWave", 21), new Enum("dashSmallGap", 22), new Enum("dashDotStroked", 23), new Enum("threeDEmboss", 24), new Enum("threeDEngrave", 25), new Enum("outset", 26), new Enum("inset", 27), new Enum("apples", 28), new Enum("archedScallops", 29), new Enum("babyPacifier", 30), 
          new Enum("babyRattle", 31), new Enum("balloons3Colors", 32), new Enum("balloonsHotAir", 33), new Enum("basicBlackDashes", 34), new Enum("basicBlackDots", 35), new Enum("basicBlackSquares", 36), new Enum("basicThinLines", 37), new Enum("basicWhiteDashes", 38), new Enum("basicWhiteDots", 39), new Enum("basicWhiteSquares", 40), 
          new Enum("basicWideInline", 41), new Enum("basicWideMidline", 42), new Enum("basicWideOutline", 43), new Enum("bats", 44), new Enum("birds", 45), new Enum("birdsFlight", 46), new Enum("cabins", 47), new Enum("cakeSlice", 48), new Enum("candyCorn", 49), new Enum("celticKnotwork", 50), 
          new Enum("certificateBanner", 51), new Enum("chainLink", 52), new Enum("champagneBottle", 53), new Enum("checkedBarBlack", 54), new Enum("checkedBarColor", 55), new Enum("checkered", 56), new Enum("christmasTree", 57), new Enum("circlesLines", 58), new Enum("circlesRectangles", 59), new Enum("classicalWave", 60), 
          new Enum("clocks", 61), new Enum("compass", 62), new Enum("confetti", 63), new Enum("confettiGrays", 64), new Enum("confettiOutline", 65), new Enum("confettiStreamers", 66), new Enum("confettiWhite", 67), new Enum("cornerTriangles", 68), new Enum("couponCutoutDashes", 69), new Enum("couponCutoutDots", 70), 
          new Enum("crazyMaze", 71), new Enum("creaturesButterfly", 72), new Enum("creaturesFish", 73), new Enum("creaturesInsects", 74), new Enum("creaturesLadyBug", 75), new Enum("crossStitch", 76), new Enum("cup", 77), new Enum("decoArch", 78), new Enum("decoArchColor", 79), new Enum("decoBlocks", 80), 
          new Enum("diamondsGray", 81), new Enum("doubleD", 82), new Enum("doubleDiamonds", 83), new Enum("earth1", 84), new Enum("earth2", 85), new Enum("eclipsingSquares1", 86), new Enum("eclipsingSquares2", 87), new Enum("eggsBlack", 88), new Enum("fans", 89), new Enum("film", 90), 
          new Enum("firecrackers", 91), new Enum("flowersBlockPrint", 92), new Enum("flowersDaisies", 93), new Enum("flowersModern1", 94), new Enum("flowersModern2", 95), new Enum("flowersPansy", 96), new Enum("flowersRedRose", 97), new Enum("flowersRoses", 98), new Enum("flowersTeacup", 99), new Enum("flowersTiny", 100), 
          new Enum("gems", 101), new Enum("gingerbreadMan", 102), new Enum("gradient", 103), new Enum("handmade1", 104), new Enum("handmade2", 105), new Enum("heartBalloon", 106), new Enum("heartGray", 107), new Enum("hearts", 108), new Enum("heebieJeebies", 109), new Enum("holly", 110), 
          new Enum("houseFunky", 111), new Enum("hypnotic", 112), new Enum("iceCreamCones", 113), new Enum("lightBulb", 114), new Enum("lightning1", 115), new Enum("lightning2", 116), new Enum("mapPins", 117), new Enum("mapleLeaf", 118), new Enum("mapleMuffins", 119), new Enum("marquee", 120), 
          new Enum("marqueeToothed", 121), new Enum("moons", 122), new Enum("mosaic", 123), new Enum("musicNotes", 124), new Enum("northwest", 125), new Enum("ovals", 126), new Enum("packages", 127), new Enum("palmsBlack", 128), new Enum("palmsColor", 129), new Enum("paperClips", 130), 
          new Enum("papyrus", 131), new Enum("partyFavor", 132), new Enum("partyGlass", 133), new Enum("pencils", 134), new Enum("people", 135), new Enum("peopleWaving", 136), new Enum("peopleHats", 137), new Enum("poinsettias", 138), new Enum("postageStamp", 139), new Enum("pumpkin1", 140), 
          new Enum("pushPinNote2", 141), new Enum("pushPinNote1", 142), new Enum("pyramids", 143), new Enum("pyramidsAbove", 144), new Enum("quadrants", 145), new Enum("rings", 146), new Enum("safari", 147), new Enum("sawtooth", 148), new Enum("sawtoothGray", 149), new Enum("scaredCat", 150), 
          new Enum("seattle", 151), new Enum("shadowedSquares", 152), new Enum("sharksTeeth", 153), new Enum("shorebirdTracks", 154), new Enum("skyrocket", 155), new Enum("snowflakeFancy", 156), new Enum("snowflakes", 157), new Enum("sombrero", 158), new Enum("southwest", 159), new Enum("stars", 160), 
          new Enum("starsTop", 161), new Enum("stars3d", 162), new Enum("starsBlack", 163), new Enum("starsShadowed", 164), new Enum("sun", 165), new Enum("swirligig", 166), new Enum("tornPaper", 167), new Enum("tornPaperBlack", 168), new Enum("trees", 169), new Enum("triangleParty", 170), 
          new Enum("triangles", 171), new Enum("tribal1", 172), new Enum("tribal2", 173), new Enum("tribal3", 174), new Enum("tribal4", 175), new Enum("tribal5", 176), new Enum("tribal6", 177), new Enum("twistedLines1", 178), new Enum("twistedLines2", 179), new Enum("vine", 180), 
          new Enum("waveline", 181), new Enum("weavingAngles", 182), new Enum("weavingBraid", 183), new Enum("weavingRibbon", 184), new Enum("weavingStrips", 185), new Enum("whiteFlowers", 186), new Enum("woodwork", 187), new Enum("xIllusions", 188), new Enum("zanyTriangles", 189), new Enum("zigZag", 190), 
          new Enum("zigZagStitch", 191) });
...
/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\STBorder.class
