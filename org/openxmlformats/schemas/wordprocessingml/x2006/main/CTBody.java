...
public interface CTBody extends XmlObject {
  ...
  public static final class Factory {
    ...
    public static CTBody newInstance(XmlOptions param1XmlOptions) {
      return (CTBody)POIXMLTypeLoader.newInstance(CTBody.type, param1XmlOptions);
    }
    
    public static CTBody parse(String param1String) throws XmlException {
      return (CTBody)POIXMLTypeLoader.parse(param1String, CTBody.type, null);
    }
    
    public static CTBody parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTBody)POIXMLTypeLoader.parse(param1String, CTBody.type, param1XmlOptions);
    }
    
    public static CTBody parse(File param1File) throws XmlException, IOException {
      return (CTBody)POIXMLTypeLoader.parse(param1File, CTBody.type, null);
    }
    
    public static CTBody parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTBody)POIXMLTypeLoader.parse(param1File, CTBody.type, param1XmlOptions);
    }
    
    public static CTBody parse(URL param1URL) throws XmlException, IOException {
      return (CTBody)POIXMLTypeLoader.parse(param1URL, CTBody.type, null);
    }
    
    public static CTBody parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTBody)POIXMLTypeLoader.parse(param1URL, CTBody.type, param1XmlOptions);
    }
    
    public static CTBody parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTBody)POIXMLTypeLoader.parse(param1InputStream, CTBody.type, null);
    }
    
    public static CTBody parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTBody)POIXMLTypeLoader.parse(param1InputStream, CTBody.type, param1XmlOptions);
    }
    
    public static CTBody parse(Reader param1Reader) throws XmlException, IOException {
      return (CTBody)POIXMLTypeLoader.parse(param1Reader, CTBody.type, null);
    }
    
    public static CTBody parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTBody)POIXMLTypeLoader.parse(param1Reader, CTBody.type, param1XmlOptions);
    }
    
    public static CTBody parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTBody)POIXMLTypeLoader.parse(param1XMLStreamReader, CTBody.type, null);
    }
    
    public static CTBody parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTBody)POIXMLTypeLoader.parse(param1XMLStreamReader, CTBody.type, param1XmlOptions);
    }
    
    public static CTBody parse(Node param1Node) throws XmlException {
      return (CTBody)POIXMLTypeLoader.parse(param1Node, CTBody.type, null);
    }
    
    public static CTBody parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTBody)POIXMLTypeLoader.parse(param1Node, CTBody.type, param1XmlOptions);
    }
    
    public static CTBody parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTBody)POIXMLTypeLoader.parse(param1XMLInputStream, CTBody.type, null);
    }
    
    public static CTBody parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTBody)POIXMLTypeLoader.parse(param1XMLInputStream, CTBody.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTBody.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTBody.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\CTBody.class
