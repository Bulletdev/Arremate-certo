...
public interface CTFtnEdn extends XmlObject {
  ...
  void setType(STFtnEdn.Enum paramEnum);
  
  void xsetType(STFtnEdn paramSTFtnEdn);
  ...
  public static final class Factory {
    ...
    public static CTFtnEdn newInstance(XmlOptions param1XmlOptions) {
      return (CTFtnEdn)POIXMLTypeLoader.newInstance(CTFtnEdn.type, param1XmlOptions);
    }
    
    public static CTFtnEdn parse(String param1String) throws XmlException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1String, CTFtnEdn.type, null);
    }
    
    public static CTFtnEdn parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1String, CTFtnEdn.type, param1XmlOptions);
    }
    
    public static CTFtnEdn parse(File param1File) throws XmlException, IOException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1File, CTFtnEdn.type, null);
    }
    
    public static CTFtnEdn parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1File, CTFtnEdn.type, param1XmlOptions);
    }
    
    public static CTFtnEdn parse(URL param1URL) throws XmlException, IOException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1URL, CTFtnEdn.type, null);
    }
    
    public static CTFtnEdn parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1URL, CTFtnEdn.type, param1XmlOptions);
    }
    
    public static CTFtnEdn parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1InputStream, CTFtnEdn.type, null);
    }
    
    public static CTFtnEdn parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1InputStream, CTFtnEdn.type, param1XmlOptions);
    }
    
    public static CTFtnEdn parse(Reader param1Reader) throws XmlException, IOException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1Reader, CTFtnEdn.type, null);
    }
    
    public static CTFtnEdn parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1Reader, CTFtnEdn.type, param1XmlOptions);
    }
    
    public static CTFtnEdn parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1XMLStreamReader, CTFtnEdn.type, null);
    }
    
    public static CTFtnEdn parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1XMLStreamReader, CTFtnEdn.type, param1XmlOptions);
    }
    
    public static CTFtnEdn parse(Node param1Node) throws XmlException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1Node, CTFtnEdn.type, null);
    }
    
    public static CTFtnEdn parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1Node, CTFtnEdn.type, param1XmlOptions);
    }
    
    public static CTFtnEdn parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1XMLInputStream, CTFtnEdn.type, null);
    }
    
    public static CTFtnEdn parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTFtnEdn)POIXMLTypeLoader.parse(param1XMLInputStream, CTFtnEdn.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTFtnEdn.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTFtnEdn.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\CTFtnEdn.class
