...
public interface CTTbl extends XmlObject {
  ...
  void setTblPr(CTTblPr paramCTTblPr);
  
  CTTblPr addNewTblPr();
  
  CTTblGrid getTblGrid();
  
  void setTblGrid(CTTblGrid paramCTTblGrid);
  ...
  CTRow getTrArray(int paramInt);
  
  int sizeOfTrArray();
  
  void setTrArray(CTRow[] paramArrayOfCTRow);
  
  void setTrArray(int paramInt, CTRow paramCTRow);
  
  CTRow insertNewTr(int paramInt);
  
  CTRow addNewTr();
  
  void removeTr(int paramInt);
  
  List<CTCustomXmlRow> getCustomXmlList();
  
  CTCustomXmlRow[] getCustomXmlArray();
  
  CTCustomXmlRow getCustomXmlArray(int paramInt);
  
  int sizeOfCustomXmlArray();
  
  void setCustomXmlArray(CTCustomXmlRow[] paramArrayOfCTCustomXmlRow);
  
  void setCustomXmlArray(int paramInt, CTCustomXmlRow paramCTCustomXmlRow);
  
  CTCustomXmlRow insertNewCustomXml(int paramInt);
  ...
  CTSdtRow getSdtArray(int paramInt);
  
  int sizeOfSdtArray();
  
  void setSdtArray(CTSdtRow[] paramArrayOfCTSdtRow);
  
  void setSdtArray(int paramInt, CTSdtRow paramCTSdtRow);
  
  CTSdtRow insertNewSdt(int paramInt);
  ...
  public static final class Factory {
    ...
    public static CTTbl newInstance(XmlOptions param1XmlOptions) {
      return (CTTbl)POIXMLTypeLoader.newInstance(CTTbl.type, param1XmlOptions);
    }
    
    public static CTTbl parse(String param1String) throws XmlException {
      return (CTTbl)POIXMLTypeLoader.parse(param1String, CTTbl.type, null);
    }
    
    public static CTTbl parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTTbl)POIXMLTypeLoader.parse(param1String, CTTbl.type, param1XmlOptions);
    }
    
    public static CTTbl parse(File param1File) throws XmlException, IOException {
      return (CTTbl)POIXMLTypeLoader.parse(param1File, CTTbl.type, null);
    }
    
    public static CTTbl parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTTbl)POIXMLTypeLoader.parse(param1File, CTTbl.type, param1XmlOptions);
    }
    
    public static CTTbl parse(URL param1URL) throws XmlException, IOException {
      return (CTTbl)POIXMLTypeLoader.parse(param1URL, CTTbl.type, null);
    }
    
    public static CTTbl parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTTbl)POIXMLTypeLoader.parse(param1URL, CTTbl.type, param1XmlOptions);
    }
    
    public static CTTbl parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTTbl)POIXMLTypeLoader.parse(param1InputStream, CTTbl.type, null);
    }
    
    public static CTTbl parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTTbl)POIXMLTypeLoader.parse(param1InputStream, CTTbl.type, param1XmlOptions);
    }
    
    public static CTTbl parse(Reader param1Reader) throws XmlException, IOException {
      return (CTTbl)POIXMLTypeLoader.parse(param1Reader, CTTbl.type, null);
    }
    
    public static CTTbl parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTTbl)POIXMLTypeLoader.parse(param1Reader, CTTbl.type, param1XmlOptions);
    }
    
    public static CTTbl parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTTbl)POIXMLTypeLoader.parse(param1XMLStreamReader, CTTbl.type, null);
    }
    
    public static CTTbl parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTTbl)POIXMLTypeLoader.parse(param1XMLStreamReader, CTTbl.type, param1XmlOptions);
    }
    
    public static CTTbl parse(Node param1Node) throws XmlException {
      return (CTTbl)POIXMLTypeLoader.parse(param1Node, CTTbl.type, null);
    }
    
    public static CTTbl parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTTbl)POIXMLTypeLoader.parse(param1Node, CTTbl.type, param1XmlOptions);
    }
    
    public static CTTbl parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTTbl)POIXMLTypeLoader.parse(param1XMLInputStream, CTTbl.type, null);
    }
    
    public static CTTbl parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTTbl)POIXMLTypeLoader.parse(param1XMLInputStream, CTTbl.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTTbl.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTTbl.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\CTTbl.class
