...
public interface CTP extends XmlObject {
  ...
  void setRsidP(byte[] paramArrayOfbyte);
  
  void xsetRsidP(STLongHexNumber paramSTLongHexNumber);
  ...
  void setRsidRDefault(byte[] paramArrayOfbyte);
  
  void xsetRsidRDefault(STLongHexNumber paramSTLongHexNumber);
  ...
  public static final class Factory {
    ...
    public static CTP newInstance(XmlOptions param1XmlOptions) {
      return (CTP)POIXMLTypeLoader.newInstance(CTP.type, param1XmlOptions);
    }
    
    public static CTP parse(String param1String) throws XmlException {
      return (CTP)POIXMLTypeLoader.parse(param1String, CTP.type, null);
    }
    
    public static CTP parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTP)POIXMLTypeLoader.parse(param1String, CTP.type, param1XmlOptions);
    }
    
    public static CTP parse(File param1File) throws XmlException, IOException {
      return (CTP)POIXMLTypeLoader.parse(param1File, CTP.type, null);
    }
    
    public static CTP parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTP)POIXMLTypeLoader.parse(param1File, CTP.type, param1XmlOptions);
    }
    
    public static CTP parse(URL param1URL) throws XmlException, IOException {
      return (CTP)POIXMLTypeLoader.parse(param1URL, CTP.type, null);
    }
    
    public static CTP parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTP)POIXMLTypeLoader.parse(param1URL, CTP.type, param1XmlOptions);
    }
    
    public static CTP parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTP)POIXMLTypeLoader.parse(param1InputStream, CTP.type, null);
    }
    
    public static CTP parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTP)POIXMLTypeLoader.parse(param1InputStream, CTP.type, param1XmlOptions);
    }
    
    public static CTP parse(Reader param1Reader) throws XmlException, IOException {
      return (CTP)POIXMLTypeLoader.parse(param1Reader, CTP.type, null);
    }
    
    public static CTP parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTP)POIXMLTypeLoader.parse(param1Reader, CTP.type, param1XmlOptions);
    }
    
    public static CTP parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTP)POIXMLTypeLoader.parse(param1XMLStreamReader, CTP.type, null);
    }
    
    public static CTP parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTP)POIXMLTypeLoader.parse(param1XMLStreamReader, CTP.type, param1XmlOptions);
    }
    
    public static CTP parse(Node param1Node) throws XmlException {
      return (CTP)POIXMLTypeLoader.parse(param1Node, CTP.type, null);
    }
    
    public static CTP parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTP)POIXMLTypeLoader.parse(param1Node, CTP.type, param1XmlOptions);
    }
    
    public static CTP parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTP)POIXMLTypeLoader.parse(param1XMLInputStream, CTP.type, null);
    }
    
    public static CTP parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTP)POIXMLTypeLoader.parse(param1XMLInputStream, CTP.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTP.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTP.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\CTP.class
