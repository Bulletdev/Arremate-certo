...
public interface CTHdrFtr extends XmlObject {
  ...
  public static final class Factory {
    ...
    public static CTHdrFtr newInstance(XmlOptions param1XmlOptions) {
      return (CTHdrFtr)POIXMLTypeLoader.newInstance(CTHdrFtr.type, param1XmlOptions);
    }
    
    public static CTHdrFtr parse(String param1String) throws XmlException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1String, CTHdrFtr.type, null);
    }
    
    public static CTHdrFtr parse(String param1String, XmlOptions param1XmlOptions) throws XmlException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1String, CTHdrFtr.type, param1XmlOptions);
    }
    
    public static CTHdrFtr parse(File param1File) throws XmlException, IOException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1File, CTHdrFtr.type, null);
    }
    
    public static CTHdrFtr parse(File param1File, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1File, CTHdrFtr.type, param1XmlOptions);
    }
    
    public static CTHdrFtr parse(URL param1URL) throws XmlException, IOException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1URL, CTHdrFtr.type, null);
    }
    
    public static CTHdrFtr parse(URL param1URL, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1URL, CTHdrFtr.type, param1XmlOptions);
    }
    
    public static CTHdrFtr parse(InputStream param1InputStream) throws XmlException, IOException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1InputStream, CTHdrFtr.type, null);
    }
    
    public static CTHdrFtr parse(InputStream param1InputStream, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1InputStream, CTHdrFtr.type, param1XmlOptions);
    }
    
    public static CTHdrFtr parse(Reader param1Reader) throws XmlException, IOException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1Reader, CTHdrFtr.type, null);
    }
    
    public static CTHdrFtr parse(Reader param1Reader, XmlOptions param1XmlOptions) throws XmlException, IOException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1Reader, CTHdrFtr.type, param1XmlOptions);
    }
    
    public static CTHdrFtr parse(XMLStreamReader param1XMLStreamReader) throws XmlException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1XMLStreamReader, CTHdrFtr.type, null);
    }
    
    public static CTHdrFtr parse(XMLStreamReader param1XMLStreamReader, XmlOptions param1XmlOptions) throws XmlException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1XMLStreamReader, CTHdrFtr.type, param1XmlOptions);
    }
    
    public static CTHdrFtr parse(Node param1Node) throws XmlException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1Node, CTHdrFtr.type, null);
    }
    
    public static CTHdrFtr parse(Node param1Node, XmlOptions param1XmlOptions) throws XmlException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1Node, CTHdrFtr.type, param1XmlOptions);
    }
    
    public static CTHdrFtr parse(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1XMLInputStream, CTHdrFtr.type, null);
    }
    
    public static CTHdrFtr parse(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return (CTHdrFtr)POIXMLTypeLoader.parse(param1XMLInputStream, CTHdrFtr.type, param1XmlOptions);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTHdrFtr.type, null);
    }
    
    public static XMLInputStream newValidatingXMLInputStream(XMLInputStream param1XMLInputStream, XmlOptions param1XmlOptions) throws XmlException, XMLStreamException {
      return POIXMLTypeLoader.newValidatingXMLInputStream(param1XMLInputStream, CTHdrFtr.type, param1XmlOptions);
    }
  }
}


/* Location:              C:\Arremate\Arremate.jar!\org\openxmlformats\schemas\wordprocessingml\x2006\main\CTHdrFtr.class
