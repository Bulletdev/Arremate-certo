...
public interface k extends XmlObject {
  public static final SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(k.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.s8C3F193EE11A2F798ACF65489B9E6078").resolveHandle("x509issuerserialtype7eb2type");
  
  String fh();
  
  XmlString e();
  
  void bQ(String paramString);
  
  void d(XmlString paramXmlString);
  ...
  void b(XmlInteger paramXmlInteger);
...
/* Location:              C:\Arremate\Arremate.jar!\org\f\a\a\a\k.class
